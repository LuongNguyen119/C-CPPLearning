...
(function () {
  const lessons = [
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          output: "Hello World!",
          explanation:
            "Viết mã C++ sau và lưu thành myfirstprogram.cpp (File > Save File as):",
        },
      ],
      tables: [],
      useCases: [
      ...
      notes: ["Lưu ý: IDE trên web cũng dùng được nhưng tính năng hạn chế."],
      commonMistakes: [
        {
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          output: "Hello World!",
          explanation:
            "Nếu quên dấu chấm phẩy ( ; ), sẽ phát sinh lỗi và chương trình không chạy:",
        },
        {
          title: "Ví dụ",
          ...
          explanation:
            "Các phát biểu được thực thi lần theo đúng thứ tự chúng được viết:",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      sections: ["Thử thách: tạo một chương trình C++ đơn giản"],
      syntax: [
        {
          code: '#include <iostream>\nusing namespace std;\n\nint main() {\n  cout << "Hello World!";\n  return 0;\n}',
          explanation:
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 11,
      prerequisites: ["cpp-challenges-syntax"],
      description:
      ...
      concept: {
        title: "Khái niệm",
        content:
          'Đối tượng cout cùng toán tử << dùng để xuất giá trị và in văn bản. Chỉ cần nhớ đặt văn bản trong nháy kép ( "" ): Bạn có thể thêm bao nhiêu cout cũng được. Tuy nhiên lưu ý nó không tự xuống dòng ở cuối kết quả: Mẹo: cách thêm dòng mới - xem chương C++ New Lines.',
      },
      sections: ["Đầu ra C++ (In văn bản)", "Ví dụ"],
      syntax: [
        {
          code: '#include <iostream>\nusing namespace std;\n\nint main() {\n  cout << "Hello World!";\n  return 0;\n}',
      ...
      notes: ["Mẹo: cách thêm dòng mới - xem chương C++ New Lines."],
      commonMistakes: [
        {
          wrong: "new mà quên delete.",
          why: "Bộ nhớ không được giải phóng gây rò rỉ (memory leak).",
    ...
    },
    {
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Bạn cũng có thể dùng cout để in số. Nhưng khác văn bản, số không đặt trong nháy kép: Bạn cũng có thể thực hiện tính toán số học:",
      },
      sections: ["Số in C++", "Ví dụ"],
      syntax: [
        {
          code: "#include <iostream>\nusing namespace std;\n\nint main() {\n  cout << 3;\n  return 0;\n}",
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 17,
      prerequisites: ["cpp-output-numbers"],
      ...
      tables: [
        {
          title: "Ví dụ",
          header: ["Trình Tự Thoát", "Mô tả", "Hãy thử làm vậy."],
          rows: [
            ["\\t", "Tạo một tab ngang", "Hãy thử làm vậy."],
            ["\\\\", "Chèn ký tự sổ chéo (\\)", "Hãy thử làm vậy."],
            ['\\"', "Chèn ký tự nháy kép", "Hãy thử làm vậy."],
          ],
        },
      ],
      useCases: [
    ...
    },
    {
      ...
      sections: ["Thử thách: in tên và tuổi"],
      syntax: [
        {
          code: '#include <iostream>\nusing namespace std;\n\nint main() {\n  cout << "Hello World!";\n  return 0;\n}',
          explanation:
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 14,
      prerequisites: ["cpp-challenges-output"],
      description:
        "Comment có thể dùng để giải thích mã C++ và làm nó dễ đọc hơn. Nó cũng có thể dùng để ngăn thực thi khi thử nghiệm mã thay thế.",
      objectives: [
      ...
      examples: [
        ...
        },
        {
          ...
          output: "Hello World!",
          explanation:
            "Mọi văn bản giữa /* và */ sẽ được trình biên dịch bỏ qua:",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          output: "10",
          explanation:
            "Lưu ý rằng gán giá trị mới cho biến đã tồn tại sẽ ghi đè giá trị trước:",
        },
        {
          title: "Ví dụ",
        ...
        },
        {
          ...
          explanation:
            "Bạn cũng có thể kết hợp các kiểu khác nhau - sẽ học ở chương sau.",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      title: "Khai báo nhiều biến trong C++",
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Để khai báo nhiều biến cùng kiểu, dùng danh sách phân tách bằng dấu phẩy: Bạn cũng có thể gán cùng một giá trị cho nhiều biến trong một dòng:",
      },
      sections: ["Khai báo nhiều biến", "Một giá trị cho nhiều biến"],
      syntax: [
        {
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 8,
      prerequisites: ["cpp-variables-multiple"],
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Mọi biến C++ phải có tên riêng (duy nhất). Những tên gọi riêng này được gọi là định danh (identifier). Định danh có thể là tên ngắn (x, y) hoặc tên mô tả hơn (age, sum, totalVolume). Lưu ý: nên dùng tên mô tả để tạo code dễ hiểu và dễ bảo trì: Quy tắc chung khi đặt tên biến là:",
      },
      sections: ["Mã định danh C++", "Ví dụ"],
      syntax: [
        {
      ...
      notes: ["Lưu ý: nên dùng tên mô tả để tạo code dễ hiểu và dễ bảo trì:"],
      commonMistakes: [
        {
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 11,
      prerequisites: ["cpp-variables-identifiers"],
      description:
        'Khi không muốn người khác (hoặc chính mình) đổi giá trị biến, dùng từ khóa const (khai báo biến là "hằng", nghĩa là không đổi và chỉ đọc):',
      objectives: [
      ...
      concept: {
        title: "Khái niệm",
        content:
          'Khi không muốn người khác (hoặc chính mình) đổi giá trị biến, dùng từ khóa const (khai báo biến là "hằng", nghĩa là không đổi và chỉ đọc): Hãy luôn khai báo biến là hằng khi giá trị khó thay đổi: Khi khai báo biến hằng (constant), phải gán giá trị ngay: Như thế này: Tuy nhiên, điều này sẽ không hoạt động:',
      },
      sections: ["dương", "Ví dụ", "Ghi chú về hằng số"],
      syntax: [
        {
    ...
    },
    {
      ...
      title: "Ví dụ thực tế về biến trong C++",
      ...
      difficulty: "beginner",
      estimatedTime: 11,
      prerequisites: ["cpp-variables-constants"],
    ...
    },
    {
      ...
      title: "Thử thách về biến trong C++",
      ...
      difficulty: "beginner",
      estimatedTime: 8,
      prerequisites: ["cpp-variables-reallife"],
      ...
      sections: ["Thử thách: tính diện tích hình chữ nhật"],
      syntax: [
        {
          code: "#include <iostream>\nusing namespace std;\n\nint main() {\n  int speed = 10;\n  cout << speed;\n  return 0;\n}",
          explanation:
      ...
      keyTakeaways: ["Kiểm tra hiểu biết về biến C++ bằng thử thách code nhỏ."],
      exerciseIds: [],
      quiz: [],
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 11,
      prerequisites: ["cpp-challenges-variables"],
      description:
    ...
    },
    {
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Như đã giải thích ở chương Variables, biến trong C++ phải có kiểu chỉ định: Kiểu dữ liệu xác định kích thước và loại thông tin biến sẽ lưu: Bạn sẽ học thêm về từng kiểu dữ liệu trong các chương tiếp theo.",
      },
      sections: ["Kiểu dữ liệu C++", "Các loại dữ liệu cơ bản"],
      syntax: [
        {
          code: "#include <iostream>\nusing namespace std;\n\nint main() {\n  int speed = 10;\n  cout << speed;\n  return 0;\n}",
          explanation:
      ...
      tables: [
        {
          ...
          header: ["Data Type", "Kích thước", "Mô tả"],
          rows: [
            ["bool", "1 byte", "Lưu giá trị đúng hoặc sai"],
            [
              "char",
              "1 byte",
              "Lưu một ký tự/chữ/số duy nhất, hoặc giá trị ASCII",
            ],
            ["int", "2 hoặc 4 byte", "Lưu số nguyên, không có phần thập phân"],
            [
              "float",
              "4 byte",
    ...
    },
    {
      ...
      concept: {
        title: "Khái niệm",
        content:
          'Dùng int khi cần lưu số nguyên không có thập phân, như 35 hay 1000; dùng float hoặc double khi cần số thực (có thập phân), như 9.99 hay 3.14515. float so với double Độ chính xác của giá trị số thực cho biết số chữ số giá trị có thể có sau dấu thập phân. Độ chính xác của float chỉ sáu hoặc bảy chữ số thập phân, trong khi biến double có độ chính xác khoảng 15 chữ số. Số thực cũng có thể viết dạng khoa học với "e" chỉ lũy thừa của 10:',
      },
      sections: ["Loại Số", "double", "Số khoa học"],
      syntax: [
        {
          code: "int myNum = 1000;\n   cout << myNum;",
          explanation:
    ...
    },
    {
      ...
      title: "Kiểu dữ liệu Boolean trong C++",
      ...
      difficulty: "beginner",
      estimatedTime: 8,
      prerequisites: ["cpp-data-types-numeric"],
      description:
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Kiểu boolean khai báo bằng từ khóa bool, chỉ nhận giá trị true hoặc false. Khi giá trị được trả về, true = 1 và false = 0. Giá trị boolean chủ yếu dùng cho kiểm tra điều kiện - sẽ học thêm ở chương sau.",
      },
      sections: ["Loại Boolean", "Ví dụ"],
      syntax: [
        {
      ...
      commonMistakes: [
        {
          wrong:
            "Gán số 1/0 trực tiếp cho biến bool thay vì biểu thức so sánh.",
    ...
    },
    {
      ...
      title: "Các loại dữ liệu ký tự C++",
      ...
      difficulty: "beginner",
      estimatedTime: 11,
      prerequisites: ["cpp-data-types-bool"],
      description:
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Kiểu char lưu một ký tự duy nhất. Ký tự phải đặt trong nháy đơn, như 'A' hay 'c': Hoặc nếu quen với ASCII, bạn có thể dùng giá trị ASCII để hiển thị một số ký tự: Mẹo: danh sách toàn bộ giá trị ASCII ở ASCII Table Reference.",
      },
      sections: ["Loại ký tự", "Ví dụ"],
      syntax: [
        {
          code: "char myGrade = 'B';\n   cout << myGrade;",
          explanation:
      ...
      notes: ["Mẹo: danh sách toàn bộ giá trị ASCII ở ASCII Table Reference."],
      commonMistakes: [
        {
          wrong: "Dùng phần tử front()/back()/top() khi container rỗng.",
          why: "Hành vi không xác định khi container trống.",
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 11,
      prerequisites: ["cpp-data-types-char"],
      description:
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Kiểu string dùng để lưu một chuỗi ký tự (văn bản). Nó không phải kiểu tích hợp sẵn, nhưng cư xử như một kiểu trong cách dùng cơ bản nhất. Để dùng chuỗi, phải include thêm tệp header trong mã nguồn, đó là thư viện <string>: Bạn sẽ học nhiều hơn về chuỗi trong Chương C++ Strings.",
      },
      sections: ["Loại Chuỗi", "Ví dụ"],
      syntax: [
        {
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 8,
      prerequisites: ["cpp-data-types-string"],
      description:
      ...
      syntax: [
        {
          ...
          explanation:
            "Ví dụ minh họa cách dùng auto để tạo biến nhiều kiểu khác nhau, dựa trên giá trị bạn gán:",
        },
      ],
      examples: [
        {
    ...
    },
    {
      ...
      title: "Ví dụ thực tế về kiểu dữ liệu trong C++",
    ...
    },
    {
      ...
      title: "Thử thách về kiểu dữ liệu trong C++",
      ...
      difficulty: "beginner",
      estimatedTime: 8,
      prerequisites: ["cpp-data-types-reallife"],
      description:
      ...
      sections: ["Thử thách: tạo bảng điểm học sinh"],
      syntax: [
        {
          code: "#include <iostream>\nusing namespace std;\n\nint main() {\n  int speed = 10;\n  cout << speed;\n  return 0;\n}",
          explanation:
    ...
    },
    {
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Toán tử dùng để thực hiện các phép toán trên biến và giá trị. Trong ví dụ dưới đây, ta dùng toán tử + để cộng hai giá trị: Dù toán tử + thường dùng để cộng hai giá trị như ví dụ trên, nó cũng dùng được để cộng biến với giá trị, hoặc biến với biến: C++ chia các toán tử thành các nhóm sau:",
      },
      sections: ["Toán tử", "Ví dụ"],
      syntax: [
        {
          code: "int x = 100 + 50;",
          explanation:
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          output: "6",
          explanation:
            "Toán tử ++ tăng giá trị lên 1, còn -- giảm giá trị đi 1:",
        },
        {
          title: "Ví dụ",
          code: '#include <iostream>\nusing namespace std;\nint main() {\n  int x = 5;\n\n  --x; // Decrement x by 1\n  cout << x << "\\n"; // 4\n  return 0;\n}\n',
        ...
        },
        {
          ...
          output: "5",
          explanation:
            "Đôi khi bạn vừa tăng vừa giảm cùng một biến. Hãy nhớ rằng nếu bạn tăng một giá trị rồi sau đó giảm nó, nó sẽ tăng lên một rồi lại giảm xuống một - kết thúc đúng chỗ nó bắt đầu.",
        },
        {
          title: "Ví dụ",
          code: '#include <iostream>\nusing namespace std;\nint main() {\n  int peopleInRoom = 0;\n\n  // 3 people enter\n  peopleInRoom++;\n  peopleInRoom++;\n  peopleInRoom++;\n\n  cout << peopleInRoom << "\\n"; // 3\n\n  // 1 person leaves\n  peopleInRoom--;\n\n  cout << peopleInRoom << "\\n"; // 2\n  return 0;\n}\n',
          output: "3\n2",
          explanation:
            "Tưởng tượng viết chương trình đếm người vào/ra phòng. Dùng ++ khi có người vào, -- khi có người rời đi:",
        },
      ],
      tables: [
        {
          title: "Toán tử số học",
          header: ["Thao Tác", "Tên", "Mô tả", "Ví dụ", "Hãy thử làm vậy."],
          rows: [
            ["+", "Thêm vào", "Cộng hai giá trị", "x + y", "Hãy thử làm vậy."],
            [
              "-",
              "Phép trừ",
            ...
            ["*", "Phép nhân", "Nhân hai giá trị", "x * y", "Hãy thử làm vậy."],
            [
              "/",
              "Phép chia",
      ...
      commonMistakes: [
        {
          wrong:
            "Truy cập phần tử ngoài chỉ mục hợp lệ (ví dụ arr[5] cho mảng 5 phần tử).",
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 14,
      prerequisites: ["cpp-operators-arithmetic"],
      ...
      examples: [
        ...
        },
        {
          ...
          output: "15\n30",
          explanation:
            "Toán tử gán kết hợp là cách viết gọn cho phép toán dùng chính biến ở hai vế. Ví dụ, thay vì viết x = x + 5;, chỉ cần viết x += 5;.",
        },
        {
          title: "Ví dụ",
          ...
          explanation:
            "Toán tử gán kết hợp cũng hữu ích trong tình huống thực tế. Ví dụ, dùng += để theo dõi tiền tiết kiệm khi gửi thêm tiền vào tài khoản:",
        },
      ],
      tables: [
        {
          title: "Ví dụ",
          header: ["Thao Tác", "Ví dụ", "Đồng thời là", "Hãy thử làm vậy."],
          rows: [
            ["=", "x = 5", "x = 5", "Hãy thử làm vậy."],
            ["+=", "x += 3", "x = x + 3", "Hãy thử làm vậy."],
            ["-=", "x -= 3", "x = x - 3", "Hãy thử làm vậy."],
            ["*=", "x *= 3", "x = x * 3", "Hãy thử làm vậy."],
            ["/=", "x /= 3", "x = x / 3", "Hãy thử làm vậy."],
            ["%=", "x %= 3", "x = x % 3", "Hãy thử làm vậy."],
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 14,
      prerequisites: ["cpp-operators-assignment"],
      description:
      ...
      examples: [
        ...
        },
        {
          ...
          output: "1\n0",
          explanation:
            "Toán tử so sánh hay dùng trong điều kiện thực tế, chẳng hạn kiểm tra tuổi bầu cử:",
        },
        {
          title: "Ví dụ",
          ...
          output: "0\n1",
          explanation:
            "Một ứng dụng phổ biến khác là kiểm tra mật khẩu đủ dài chưa:",
        },
      ],
      tables: [
        {
          title: "Ví dụ",
          header: ["Thao Tác", "Tên", "Ví dụ", "Hãy thử làm vậy."],
          rows: [
            ["==", "Tương đương với", "x == y", "Hãy thử làm vậy."],
            ["!=", "Không công bằng", "x != y", "Hãy thử làm vậy."],
            [">", "Lớn hơn", "x > y", "Hãy thử làm vậy."],
            ["<", "Ít hơn", "x < y", "Hãy thử làm vậy."],
            [">=", "Lớn hơn hoặc bằng", "x >= y", "Hãy thử làm vậy."],
            ["<=", "Nhỏ hơn hoặc bằng", "x <= y", "Hãy thử làm vậy."],
          ],
        },
      ],
      useCases: [
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 8,
      prerequisites: ["cpp-operators-comparison"],
      description:
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Cũng như toán tử so sánh, bạn có thể kiểm tra giá trị true (1) hoặc false (0) bằng toán tử logic. Toán tử logic dùng để xác định quan hệ logic giữa các biến hoặc giá trị: Bạn sẽ học nhiều hơn về true/false trong chương sau.",
      },
      sections: ["Toán tử logic"],
      syntax: [
        {
          code: '#include <iostream>\nusing namespace std;\n\nint main() {\n  int a = 7, b = 4;\n  cout << a + b << " " << a % b;\n  return 0;\n}',
          explanation:
    ...
    },
    {
      ...
      title: "Độ ưu tiên toán tử trong C++",
      ...
      difficulty: "beginner",
      estimatedTime: 11,
      prerequisites: ["cpp-operators-logical"],
      description:
      ...
      examples: [
        ...
        },
        {
          ...
          output: "13\n3",
          explanation:
            "Phép trừ và cộng thực hiện từ trái sang phải, trừ khi thêm ngoặc đơn:",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      title: "Thử thách về toán tử trong C++",
      ...
      difficulty: "beginner",
      estimatedTime: 8,
      prerequisites: ["cpp-operators-precedence"],
      ...
      sections: ["Thử thách: tính tổng chi phí của một mặt hàng"],
      syntax: [
        {
          code: '#include <iostream>\nusing namespace std;\n\nint main() {\n  int a = 7, b = 4;\n  cout << a + b << " " << a % b;\n  return 0;\n}',
          explanation:
    ...
    },
    {
      ...
      concept: {
        title: "Khái niệm",
        content:
          'Chuỗi dùng để lưu văn bản/ký tự. Ví dụ, "Hello World" là một chuỗi. Biến chuỗi chứa một tập hợp ký tự đặt trong nháy kép ( "" ): Tạo biến kiểu string và gán giá trị: Để dùng chuỗi, phải include thêm tệp header trong mã nguồn, đó là thư viện <string>: Lưu ý: chuỗi có thể chứa nhiều từ, khoảng trắng và dấu câu:',
      },
      sections: ["Chuỗi C++", "Ví dụ"],
      syntax: [
        {
          code: 'string greeting = "Hello";',
      ...
      notes: ["Lưu ý: chuỗi có thể chứa nhiều từ, khoảng trắng và dấu câu:"],
      commonMistakes: [
        {
          wrong: "Quên #include <string> khi dùng std::string.",
          why: "string không phải kiểu dựng sẵn — thiếu header sẽ không biên dịch.",
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          output: "John Doe",
          explanation:
            "Ở ví dụ trên, ta thêm khoảng trắng sau firstName để tạo khoảng trống giữa John và Doe khi xuất. Tuy nhiên cũng có thể thêm khoảng trắng bằng nháy (\" \" hoặc ' '):",
        },
        {
          title: "Ví dụ",
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 8,
      prerequisites: ["cpp-strings-concat"],
      ...
      concept: {
        title: "Khái niệm",
        content:
          "C++ dùng toán tử + cho cả phép cộng và phép nối chuỗi. Số được cộng. Chuỗi được nối. Nếu cộng hai số, kết quả sẽ là một số: Nếu cộng hai chuỗi, kết quả là một chuỗi được nối: Nếu cộng một số với chuỗi, sẽ phát sinh lỗi:",
      },
      sections: ["Cộng số và chuỗi", "Ví dụ"],
      syntax: [
        {
          code: 'string x = "10";\n   int y = 20;\n   string z = x + y;',
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 11,
      prerequisites: ["cpp-strings-numbers"],
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Để lấy độ dài chuỗi, dùng hàm length(): Mẹo: bạn có thể gặp code C++ dùng size() để lấy độ dài chuỗi. Đó chỉ là bí danh của length().",
      },
      sections: ["Chiều Dài Chuỗi Ký Tự", "Ví dụ"],
      syntax: [
        {
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 20,
      prerequisites: ["cpp-strings-length"],
      description:
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Bạn truy cập ký tự trong chuỗi bằng chỉ mục trong ngoặc vuông []. Ví dụ này in ký tự đầu tiên của myString: Lưu ý: chỉ mục chuỗi bắt đầu từ 0: [0] là ký tự đầu, [1] là ký tự thứ hai, v.v. Ví dụ này in ký tự thứ hai của myString: Để in ký tự cuối của chuỗi, dùng đoạn mã sau: Để đổi giá trị một ký tự trong chuỗi, hãy chỉ số mục và dùng nháy đơn: Thư viện <string> cũng có hàm at() để truy cập ký tự trong chuỗi: Mẹo: danh sách hàm string hữu ích khác ở String Functions Reference.",
      },
      sections: [
        "Chuỗi truy cập",
        "Ví dụ",
      ...
      examples: [
        ...
        },
        {
          ...
          output: "Jello",
          explanation:
            "Để đổi giá trị một ký tự trong chuỗi, hãy chỉ số mục và dùng nháy đơn:",
        },
        {
          title: "Ví dụ",
          ...
          explanation:
            "Thư viện <string> cũng có hàm at() để truy cập ký tự trong chuỗi:",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      id: "cpp-strings-esc",
      slug: "strings-esc",
      title: "Ký tự đặc biệt trong chuỗi C++",
      ...
      difficulty: "beginner",
      estimatedTime: 8,
      prerequisites: ["cpp-strings-access"],
      description:
      ...
      tables: [
        {
          title: "Chuỗi - ký tự đặc biệt",
          header: ["Nhân vật thoát hiểm", "Kết quả", "Mô tả"],
          rows: [
            ["\\'", "'", "Báo giá đơn"],
            ['\\"', '"', "Báo giá gấp đôi"],
            ["\\\\", "\\", "Xoá lùi"],
        ...
        {
          title: "Chuỗi - ký tự đặc biệt",
          header: ["Ký tự Thoát", "Kết quả", "Hãy thử làm vậy."],
          rows: [
            ["\\n", "Dòng mới", "Hãy thử làm vậy."],
            ["\\t", "Vấu", "Hãy thử làm vậy."],
          ],
        },
      ],
    ...
    },
    {
      ...
      slug: "strings-input",
      title: "Chuỗi nhập từ người dùng trong C++",
      ...
      examples: [
        ...
        },
        {
          ...
          output: "",
          explanation:
            "Tuy nhiên, cin coi khoảng trắng (space, tab, v.v.) là ký tự kết thúc, nghĩa là nó chỉ lưu được một từ (dù bạn gõ nhiều từ):",
        },
        {
          title: "Ví dụ",
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 8,
      prerequisites: ["cpp-strings-input"],
      description:
        "Bạn có thể thấy một số chương trình C++ chạy mà không cần thư viện standard namespace. Dòng using namespace std có thể được bỏ và thay bằng từ khóa std, theo sau là toán tử :: cho các đối tượng string (và cout):",
      objectives: [
        "Nắm được: Chuỗi C++.",
      ...
      sections: ["Bỏ qua Không gian tên", "Ví dụ"],
      syntax: [
        {
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 8,
      prerequisites: ["cpp-strings-namespace"],
    ...
    },
    {
      ...
      title: "Thử thách về chuỗi trong C++",
      ...
      difficulty: "beginner",
      estimatedTime: 8,
      prerequisites: ["cpp-strings-cstyle"],
      ...
      sections: ["Thử thách: tạo lời chào"],
      syntax: [
        {
          code: '#include <iostream>\n#include <string>\nusing namespace std;\n\nint main() {\n  string txt = "C++";\n  cout << txt + " is fun" << " " << txt.size();\n  return 0;\n}',
          explanation:
    ...
    },
    {
      ...
      concept: {
        title: "Khái niệm",
        content:
          "C++ có nhiều hàm cho phép thực hiện các phép toán trên số. Hàm max(x, y) tìm giá trị lớn hơn giữa x và y: Và hàm min(x, y) tìm giá trị nhỏ hơn giữa x và y: Các hàm khác như sqrt (căn bậc hai), round (làm tròn) và log (logarit tự nhiên) nằm trong tệp header <cmath>: Tham chiếu đầy đủ các hàm toán học: xem C++ Math Reference.",
      },
      sections: [
        "Toán C++",
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          output: "true\nfalse",
          explanation:
            "Nếu muốn in true/false thành chữ thay vì 1 và 0, dùng manipulator boolalpha:",
        },
        {
          title: "Ví dụ",
          ...
          output: "true\n1",
          explanation:
            "Nếu muốn trở lại mặc định (in 1 và 0), dùng noboolalpha:",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      title: "Biểu thức Boolean trong C++",
      ...
      sections: ["Biểu thức Boolean", "Ví dụ", "Lưu kết quả vào biến Boolean"],
      syntax: [
        {
      ...
      examples: [
        ...
        },
        {
          ...
          output: "1",
          explanation:
            "Các ví dụ dưới đây dùng toán tử bằng ( == ) để đánh giá biểu thức:",
        },
        {
          title: "Ví dụ",
    ...
    },
    {
      ...
      title: "Ví dụ thực tế về Boolean trong C++",
      ...
      difficulty: "beginner",
      estimatedTime: 11,
      prerequisites: ["cpp-booleans-expressions"],
      description:
      ...
      concept: {
        title: "Khái niệm",
        content:
          'Hãy dùng boolean trong ví dụ thực tế: xác định một người có đủ tuổi bầu cử không. Ví dụ dưới đây, ta dùng toán tử so sánh >= để xem tuổi (25) có LỚN HƠN HOẶC BẰNG giới hạn tuổi bầu cử, đặt ở 18: Hay không? Cách tốt hơn nữa (đang vào đà rồi), là bọc mã trên trong if...else để làm các việc khác nhau tùy kết quả: In "Old enough to vote!" nếu myAge >= 18. Ngược lại in "Not old enough to vote.": Boolean là nền tảng của mọi phép so sánh và điều kiện trong C++. Bạn sẽ học thêm về điều kiện (if...else) trong chương tiếp theo.',
      },
      sections: ["Ví dụ thực tế", "Ví dụ"],
      syntax: [
        {
    ...
    },
    {
      ...
      title: "Thử thách về Boolean trong C++",
      ...
      difficulty: "beginner",
      estimatedTime: 8,
      prerequisites: ["cpp-booleans-reallife"],
      ...
      sections: ["Thử thách: kiểm tra độ tuổi tối thiểu"],
      syntax: [
        {
          code: '#include <iostream>\n#include <cmath>\nusing namespace std;\n\nint main() {\n  cout << sqrt(16) << " " << (5 > 3);\n  return 0;\n}',
          explanation:
      ...
      syntax: [
        {
          ...
          explanation:
            "Ví dụ dưới đây kiểm tra xem 20 có lớn hơn 18 không. Nếu điều kiện đúng, ta in một thông điệp:",
        },
      ],
      examples: [
        {
        ...
        },
        {
          ...
          output: "x is greater than y",
          explanation:
            "Vì điều kiện trong if phải là true hoặc false, bạn có thể lưu kết quả vào biến boolean thay vì viết phép so sánh trực tiếp:",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      notes: ["Mẹo: tên kiểu isDay giúp dễ hiểu điều kiện có ý nghĩa gì."],
      commonMistakes: [
        {
          wrong:
            "Gán số 1/0 trực tiếp cho biến bool thay vì biểu thức so sánh.",
    ...
    },
    {
      ...
      title: "Câu lệnh else if trong C++",
      ...
      difficulty: "beginner",
      estimatedTime: 11,
      prerequisites: ["cpp-conditions-else"],
      description:
      ...
      examples: [
        ...
        },
        {
          ...
          output: "Good day.",
          explanation:
            "Cũng như với if, bạn có thể lưu điều kiện vào biến boolean rồi dùng với else if:",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      title:
        "If Else rút gọn (toán tử ba ngôi) trong C++ (C++ Short Hand If Else (Ternary Operator))",
      ...
      difficulty: "beginner",
      estimatedTime: 20,
      prerequisites: ["cpp-conditions-elseif"],
      description:
      ...
      examples: [
        ...
        },
        {
          ...
          output: "Good evening.",
          explanation:
            "Bạn có thể lồng toán tử ba ngôi để xử lý nhiều hơn hai kết quả, nhưng code sẽ khó đọc hơn:",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 11,
      prerequisites: ["cpp-conditions-shorthand"],
      description:
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Bạn cũng có thể đặt if trong if khác. Đó gọi là câu lệnh if lồng nhau. If lồng nhau cho phép kiểm tra một điều kiện chỉ khi điều kiện khác đã đúng. Ví dụ này, đầu tiên ta kiểm tra x có lớn hơn 10 không; nếu đúng, ta kiểm tra tiếp y có lớn hơn 20 không: Tự trải nghiệm If lồng nhau hữu ích khi cần kiểm nhiều điều kiện phụ thuộc nhau. Ví dụ kiểm tra người đủ tuổi bầu cử và là công dân: Tự trải nghiệm",
      },
      sections: ["Lồng nhau nếu", "Ví dụ", "Ví dụ thực tế"],
      syntax: [
        {
      ...
      examples: [
        ...
        },
        {
          ...
          explanation:
            "If lồng nhau hữu ích khi cần kiểm nhiều điều kiện phụ thuộc nhau. Ví dụ kiểm tra người đủ tuổi bầu cử và là công dân:",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      title: "Toán tử logic trong điều kiện C++",
      ...
      difficulty: "beginner",
      estimatedTime: 17,
      prerequisites: ["cpp-conditions-nested"],
      description:
      ...
      examples: [
        ...
        },
        {
          ...
          explanation:
            "Bạn phải đăng nhập, và cần là admin hoặc có mức bảo mật cao (bậc 1 hoặc 2):",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      title: "Ví dụ thực tế If Else trong C++",
      ...
      difficulty: "beginner",
      estimatedTime: 20,
      prerequisites: ["cpp-conditions-logical"],
      description:
    ...
    },
    {
      ...
      title: "Thử thách về điều kiện trong C++",
      ...
      difficulty: "beginner",
      estimatedTime: 8,
      prerequisites: ["cpp-conditions-reallife"],
      description:
      ...
      sections: ["Thử thách: ra quyết định với If và Else"],
      syntax: [
        {
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 14,
      prerequisites: ["cpp-challenges-conditions"],
      description:
      ...
      concept: {
        title: "Khái niệm",
        content:
          'Dùng câu lệnh switch để chọn một trong nhiều khối mã để thực thi. Phải vậy thôi. Ví dụ dưới đây dùng số thứ để tính tên thứ trong tuần: Khi gặp break trong switch, chương trình thoát khỏi khối switch. Điều này ngăn chạy tiếp mã và kiểm tra case trong khối. Khi tìm thấy khớp và xong việc, đã đến lúc break. Không cần kiểm tra thêm. Một break tiết kiệm nhiều thời gian thực thi vì nó "bỏ qua" mọi mã còn lại trong khối switch. Từ khóa default chỉ định mã chạy khi không có case nào khớp:',
      },
      sections: [
      ...
      examples: [
        ...
        },
        {
          ...
          explanation:
            "Từ khóa default chỉ định mã chạy khi không có case nào khớp:",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      sections: ["Thử thách: sửa đơn hàng của khách"],
      syntax: [
        {
          code: '#include <iostream>\nusing namespace std;\n\nint main() {\n  int time = 20;\n  if (time < 18) { cout << "Good time!"; } else { cout << "Not good time"; }\n  return 0;\n}',
          explanation:
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          output: "3\n2\n1\nHappy New Year!!",
          explanation:
            'Ví dụ này đếm ngược từ 3 xuống 1 rồi hiển thị "Happy New Year!!":',
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 17,
      prerequisites: ["cpp-while-loop"],
      description:
        "Vòng lặp do/while là biến thể của while. Vòng lặp này thực thi khối mã một lần trước khi kiểm tra điều kiện có đúng không.",
      objectives: [
      ...
      examples: [
        ...
        },
        {
          ...
          output: "0\n1\n2\n3\n4",
          explanation:
            "Ví dụ dưới dùng do/while. Vòng lặp luôn chạy ít nhất một lần dù điều kiện sai, vì khối mã chạy trước khi kiểm tra điều kiện.",
        },
        {
          title: "Ví dụ",
          code: '#include <iostream>\nusing namespace std;\nint main() {\n  int i = 10;\n   do {\n     cout << "i is " << i << "\\n";\n     i++;\n   } while (i < 5);\n  return 0;\n}\n',
          output: "i is 10",
          explanation:
            "Ví dụ dưới đây, biến i bắt đầu từ 10 nên điều kiện i < 5 sai ngay - nhưng vòng lặp do/while vẫn chạy một lần:",
        },
        {
          title: "Ví dụ",
          ...
          output: "",
          explanation:
            "Ví dụ này liên tục hỏi người dùng nhập số dương. Vòng lặp dừng khi nhập 0 hoặc số âm:",
          input: "5 -1",
        },
      ],
      tables: [],
      ...
      notes: ["Lưu ý: dấu chấm phẩy ; sau điều kiện while là bắt buộc!"],
      commonMistakes: [
        {
          wrong: "Vòng lặp while không có câu lệnh làm thay đổi điều kiện.",
          why: "Điều kiện không bao giờ sai → lặp vô hạn.",
    ...
    },
    {
      ...
      title: "Ví dụ thực tế vòng lặp While trong C++",
      ...
      difficulty: "beginner",
      estimatedTime: 17,
      prerequisites: ["cpp-do-while-loop"],
      description:
    ...
    },
    {
      ...
      title: "Thử thách vòng lặp While trong C++",
      ...
      difficulty: "beginner",
      estimatedTime: 8,
      prerequisites: ["cpp-while-loop-reallife"],
      description:
      ...
      sections: ["Thử thách: đếm từ 1 đến 5"],
      syntax: [
        {
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 20,
      prerequisites: ["cpp-challenges-while-loop"],
    ...
    },
    {
      ...
      concept: {
        title: "Khái niệm",
        content:
          'Cũng có thể đặt vòng lặp trong vòng lặp khác. Đó gọi là vòng lặp lồng. "Vòng lặp trong" chạy một lần cho mỗi lượt của "vòng lặp ngoài": Ví dụ này dùng vòng lặp lồng để in bảng cửu chương đơn giản (1 đến 3): Vòng lặp lồng hữu ích khi làm việc với bảng, ma trận hoặc cấu trúc dữ liệu nhiều chiều.',
      },
      sections: ["Vòng lặp lồng nhau", "Ví dụ bảng cửu chương", "Ví dụ"],
      syntax: [
        {
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 11,
      prerequisites: ["cpp-for-loop-nested"],
      description:
    ...
    },
    {
      ...
      title: "Ví dụ thực tế vòng lặp For trong C++",
      ...
      difficulty: "beginner",
      estimatedTime: 20,
      prerequisites: ["cpp-for-loop-foreach"],
      description:
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Để minh họa ví dụ thực tế của vòng lặp for, hãy tạo chương trình đếm đến 100 theo chục: Ví dụ này tạo chương trình chỉ in số chẵn từ 0 đến 10 (bao gồm 2 đầu): Ở đây ta chỉ in các số lẻ: Ví dụ này in các lũy thừa của 2 đến 512: Và ví dụ này tạo chương trình in bảng cửu chương của một số cho trước:",
      },
      sections: ["Ví dụ thực tế", "Ví dụ"],
      syntax: [
        {
      ...
      examples: [
        ...
        },
        {
          ...
          output:
            "2 x 1 = 2\n2 x 2 = 4\n2 x 3 = 6\n2 x 4 = 8\n2 x 5 = 10\n2 x 6 = 12\n2 x 7 = 14\n2 x 8 = 16\n2 x 9 = 18\n2 x 10 = 20",
          explanation:
            "Và ví dụ này tạo chương trình in bảng cửu chương của một số cho trước:",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      title: "Thử thách vòng lặp For trong C++",
      ...
      difficulty: "beginner",
      estimatedTime: 8,
      prerequisites: ["cpp-for-loop-reallife"],
      description:
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 17,
      prerequisites: ["cpp-challenges-for-loop"],
      description:
      ...
      examples: [
        ...
        },
        {
          ...
          output: "0\n1\n2\n3",
          explanation:
            "Bạn cũng có thể dùng break và continue trong vòng lặp while:",
        },
        {
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          output: "Opel",
          explanation:
            "Để đổi giá trị một phần tử cụ thể, hãy chỉ số mục của nó:",
          input: "",
        },
        {
          title: "Ví dụ",
    ...
    },
    {
      id: "cpp-arrays-loop",
      slug: "arrays-loop",
      title: "Vòng lặp qua mảng trong C++",
    ...
    },
    {
      id: "cpp-arrays-omit",
      slug: "arrays-omit",
      title: "Bỏ qua kích thước và phần tử mảng khi khai báo trong C++",
      ...
      examples: [
        ...
        },
        {
          ...
          output: "",
          explanation:
            "Lý do là kích thước mảng trong C++ cố định, không thể thêm/xóa phần tử sau khi tạo.",
          runnable: false,
        },
        {
          title: "Vectơ",
          ...
          output: "",
          explanation:
            "Vector nằm trong thư viện <vector> và đi kèm nhiều hàm hữu ích để thêm, xóa và sửa phần tử:",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      id: "cpp-arrays-size",
      slug: "arrays-size",
      title: "Lấy kích thước mảng trong C++",
      ...
      examples: [
        ...
        },
        {
          ...
          output: "5",
          explanation:
            "Để biết mảng có bao nhiêu phần tử, phải chia kích thước mảng cho kích thước phần tử đầu tiên:",
        },
        {
        ...
        },
        {
          ...
          output: "10\n20\n30\n40\n50",
          explanation:
            'Lưu ý, từ C++11 (2011), bạn cũng có thể dùng vòng lặp "for-each" - gọn và đơn giản hơn:',
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      title: "Ví dụ thực tế về mảng trong C++",
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Để minh họa ví dụ thực tế của mảng, hãy tạo chương trình tính tuổi trung bình của nhiều người: Và ví dụ này tạo chương trình tìm tuổi nhỏ nhất trong các tuổi:",
      },
      sections: ["Ví dụ thực tế", "Ví dụ"],
      syntax: [
        {
    ...
    },
    {
      id: "cpp-arrays-multi",
      slug: "arrays-multi",
      title: "Mảng nhiều chiều trong C++",
      ...
      difficulty: "beginner",
      estimatedTime: 20,
      prerequisites: ["cpp-arrays-reallife"],
      ...
      syntax: [
        {
          ...
          explanation:
            "Để khai báo mảng nhiều chiều, định nghĩa kiểu biến, chỉ định tên mảng theo sau là ngoặc vuông chỉ số phần tử của mảng chính, tiếp theo là một cặp ngoặc vuông khác chỉ số phần tử của mảng con:",
        },
      ],
      examples: [
        {
        ...
        },
        {
          ...
          output: "",
          explanation:
            "Giống mảng thường, bạn chèn giá trị bằng array literal - danh sách phân tách dấu phẩy trong ngoặc nhọn. Với mảng nhiều chiều, mỗi phần tử của array literal lại là một array literal.",
        },
        {
          title: "Mảng nhiều chiều",
          ...
          output: "",
          explanation:
            "Mảng có thể có bao nhiêu chiều cũng được. Càng nhiều chiều, code càng phức tạp.",
        },
        {
          title: "Ví dụ",
          ...
          output: "C",
          explanation:
            "Phát biểu này truy cập giá trị phần tử ở hàng đầu tiên (0) và cột thứ ba (2) của mảng letters.",
        },
        {
          title: "Ví dụ",
          ...
          output: "Z",
          explanation:
            "Để đổi giá trị một phần tử, hãy chỉ số mục của nó ở từng chiều:",
        },
        {
          title: "Ví dụ",
          code: '#include <iostream>\n#include <string>\nusing namespace std;\nint main() {\n  string letters[2][4] = {\n    { "A", "B", "C", "D" },\n    { "E", "F", "G", "H" }\n  };\n\n  for (int i = 0; i < 2; i++) {\n    for (int j = 0; j < 4; j++) {\n      cout << letters[i][j] << "\\n";\n    }\n  }\n  return 0;\n}\n',
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 8,
      prerequisites: ["cpp-arrays-multi"],
      ...
      sections: ["Thử thách: tạo một mảng đơn giản"],
      syntax: [
        {
      ...
      keyTakeaways: ["Kiểm tra hiểu biết về mảng C++ bằng thử thách code nhỏ."],
      exerciseIds: [],
      quiz: [],
    ...
    },
    {
      id: "cpp-structs",
      slug: "structs",
      title: "Cấu trúc (struct) trong C++ (C++ Structures (struct))",
      ...
      syntax: [
        {
          ...
          explanation:
            "Sau khi khai báo, hãy chỉ định tên biến cấu trúc (myStructure trong ví dụ dưới):",
        },
      ],
      examples: [
        {
        ...
        },
        {
          ...
          output: "Xem vi du trong bai hoc",
          explanation:
            "Bạn có thể dùng dấu phẩy ( , ) để dùng một cấu trúc cho nhiều biến:",
        },
        {
          title: "Ví dụ",
        ...
        },
        {
          ...
          output: "Xem vi du trong bai hoc",
          explanation:
            "Để tạo cấu trúc có tên, đặt tên cấu trúc ngay sau từ khóa struct:",
        },
        {
          title: "Cấu trúc được đặt tên",
          code: '#include <string>\nusing namespace std;\nstruct car {  // This structure is now named "car"\n  string brand;\n  string model;\n  int year;\n};\n\nint main() {\n  car myCar1;\n  return 0;\n}\n',
          output: "",
          explanation:
            "Để khai báo biến dùng cấu trúc, hãy lấy tên cấu trúc làm kiểu dữ liệu của biến:",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      id: "cpp-enum",
      slug: "enum",
      title: "Liệt kê (enum) trong C++ (C++ Enumeration (enum))",
      ...
      examples: [
        ...
        },
        {
          ...
          output: "Xem vi du trong bai hoc",
          explanation:
            "Bên trong phương thức main(), dùng từ khóa enum, theo sau là tên enum (Level) rồi tên biến enum (myVar trong ví dụ này):",
        },
        {
          title: "Kiểu liệt kê C++ (C++ Enums)",
          ...
          output: "Xem vi du trong bai hoc",
          explanation:
            "Giá trị gán phải là một trong các mục bên trong enum (LOW, MEDIUM hoặc HIGH):",
        },
        {
          title: "Kiểu liệt kê C++ (C++ Enums)",
          ...
          output: "1",
          explanation:
            "Nếu in myVar bây giờ, kết quả là 1, tương ứng với MEDIUM:",
        },
        {
    ...
    },
    {
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Biến tham chiếu là bí danh của biến đã tồn tại, tạo bằng toán tử &: Bây giờ, food hay meal đều trỏ tới cùng một giá trị: Lưu ý: cả food và meal cùng trỏ một vị trí bộ nhớ. Đổi một cái sẽ ảnh hưởng cái kia. Nếu đổi giá trị biến tham chiếu, biến gốc cũng đổi (và ngược lại), vì cả hai trỏ tới cùng một vị trí bộ nhớ:",
      },
      sections: [
    ...
    },
    {
      ...
      description:
        "Trong ví dụ từ trang trước, toán tử & được dùng để tạo biến tham chiếu. Nhưng nó cũng có thể được dùng để lấy địa chỉ bộ nhớ của một biến; đó là vị trí biến được lưu trên máy tính.",
      objectives: [
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Trong ví dụ từ trang trước, toán tử & được dùng để tạo biến tham chiếu. Nhưng nó cũng có thể được dùng để lấy địa chỉ bộ nhớ của một biến; đó là vị trí biến được lưu trên máy tính. Khi một biến được tạo trong C++, một địa chỉ bộ nhớ được gán cho biến. Và khi gán giá trị cho biến, giá trị được lưu tại địa chỉ bộ nhớ đó. Để truy cập nó, dùng toán tử &, kết quả cho biết biến lưu ở đâu: Lưu ý: địa chỉ bộ nhớ dạng thập lục phân (0x..). Có thể bạn không nhận được kết quả giống hệt. Tham chiếu và con trỏ (bạn sẽ học trong chương tiếp theo) quan trọng trong C++, vì chúng cho bạn khả năng thao tác dữ liệu trong bộ nhớ máy tính - điều có thể giảm code và cải thiện hiệu năng. Hai tính năng này là điều làm C++ nổi bật so với các ngôn ngữ khác như Python và Java.",
      },
      sections: ["Địa chỉ bộ nhớ", "Ví dụ"],
      syntax: [
        {
    ...
    },
    {
      ...
      difficulty: "intermediate",
      estimatedTime: 14,
      prerequisites: ["cpp-references-memory"],
      description:
    ...
    },
    {
      ...
      title: "Truy cập giá trị qua con trỏ",
      ...
      difficulty: "intermediate",
      estimatedTime: 8,
      prerequisites: ["cpp-pointers"],
      description:
        "Trong ví dụ từ trang trước, ta đã dùng biến con trỏ để lấy địa chỉ bộ nhớ của một biến (dùng cùng toán tử tham chiếu &). Tuy nhiên, bạn cũng có thể dùng con trỏ để lấy giá trị của biến, bằng cách dùng toán tử * (toán tử  giải tham)…",
      objectives: [
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Trong ví dụ từ trang trước, ta đã dùng biến con trỏ để lấy địa chỉ bộ nhớ của một biến (dùng cùng toán tử tham chiếu &). Tuy nhiên, bạn cũng có thể dùng con trỏ để lấy giá trị của biến, bằng cách dùng toán tử * (toán tử giải tham): Lưu ý dấu * dễ gây nhầm vì nó làm hai việc khác nhau trong code:",
      },
      sections: ["Lấy địa chỉ bộ nhớ và giá trị", "Ví dụ"],
      syntax: [
        {
    ...
    },
    {
      ...
      title: "Thay đổi giá trị con trỏ trong C++",
      ...
      difficulty: "intermediate",
      estimatedTime: 8,
      prerequisites: ["cpp-pointers-dereference"],
      description:
      ...
      sections: ["Thay đổi giá trị của con trỏ"],
      syntax: [
        {
    ...
    },
    {
      ...
      difficulty: "intermediate",
      estimatedTime: 11,
      prerequisites: ["cpp-pointers-modify"],
      description:
      ...
      syntax: [{ code: "int myNumber = 10;", explanation: "Ví dụ:" }],
      examples: [
        {
        ...
        },
        {
          ...
          output: "4\n4\n8\n1",
          explanation:
            "Bạn có thể kiểm tra bộ nhớ một kiểu biến bằng toán tử sizeof:",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      difficulty: "intermediate",
      estimatedTime: 17,
      prerequisites: ["cpp-memory-management"],
      ...
      examples: [
        ...
        },
        {
          ...
          output: "",
          explanation:
            "Ví dụ, tưởng tượng bạn điều hành một khách sạn. Vì không biết bao nhiêu khách sẽ đến, bạn hỏi người dùng số lượng và tạo đúng số phòng - mỗi phòng lưu tên một khách:",
        },
        {
          ...
          output: "",
          explanation:
            "Trong hầu hết trường hợp, bạn không cần dùng new. C++ tự quản lý bộ nhớ cho biến thường như:",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          output: "I just got executed!",
          explanation:
            "Bạn thường gặp chương trình C++ đặt khai báo hàm phía trên main() và định nghĩa hàm phía dưới main(). Cách này làm code gọn gàng, dễ đọc hơn:",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      difficulty: "intermediate",
      estimatedTime: 8,
      prerequisites: ["cpp-function-param"],
      ...
      concept: {
        title: "Khái niệm",
        content:
          'Bạn cũng có thể đặt tham số mặc định bằng dấu bằng ( = ). Nếu gọi hàm không có đối số, nó dùng giá trị mặc định ("Norway"): Tham số có giá trị mặc định thường được gọi là "tham số tùy chọn". Từ ví dụ trên, country là tham số tùy chọn và "Norway" là giá trị mặc định.',
      },
      sections: ["Giá trị thông số mặc định", "Ví dụ"],
      syntax: [
        {
    ...
    },
    {
      ...
      difficulty: "intermediate",
      estimatedTime: 8,
      prerequisites: ["cpp-function-default"],
      description:
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Bên trong hàm, bạn có thể thêm bao nhiêu tham số cũng được: Lưu ý khi làm việc với nhiều tham số, lời gọi hàm phải có đúng số đối số như tham số, và các đối số phải truyền theo đúng thứ tự.",
      },
      sections: ["Nhiều thông số", "Ví dụ"],
      syntax: [
        {
    ...
    },
    {
      ...
      difficulty: "intermediate",
      estimatedTime: 17,
      prerequisites: ["cpp-function-multiple"],
      description:
        "Từ khóa void, dùng trong các ví dụ trước, chỉ ra rằng hàm không nên trả về giá trị. Nếu muốn hàm trả về giá trị, bạn có thể dùng một kiểu dữ liệu (như int, string, v.v.) thay vì void, và dùng từ khóa return bên trong hàm…",
      objectives: [
        "Nắm được: Hàm C++.",
      ...
      concept: {
        title: "Khái niệm",
        content:
          'Từ khóa void, dùng trong các ví dụ trước, chỉ ra rằng hàm không nên trả về giá trị. Nếu muốn hàm trả về giá trị, bạn có thể dùng một kiểu dữ liệu (như int, string, v.v.) thay vì void, và dùng từ khóa return bên trong hàm: Ví dụ này trả về tổng từ hàm có hai tham số: Bạn cũng có thể lưu kết quả vào biến: Đây là "ví dụ game" đơn giản và vui dùng hàm có return để nhân đôi một số năm lần:',
      },
      sections: ["Giá trị trả về", "Ví dụ", "Ví dụ thực tế"],
      syntax: [
        {
    ...
    },
    {
      ...
      difficulty: "intermediate",
      estimatedTime: 14,
      prerequisites: ["cpp-function-return"],
      description:
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Trong các ví dụ ở trang trước, ta đã dùng biến thường khi truyền tham số vào hàm. Bạn cũng có thể truyền một tham chiếu vào hàm. Hữu ích khi bạn cần thay đổi giá trị của tham số: Truyền số nguyên theo tham chiếu: Truyền hai số nguyên theo tham chiếu: Truyền chuỗi theo tham chiếu:",
      },
      sections: ["Chuyển qua tham chiếu", "Ví dụ"],
      syntax: [
        {
    ...
    },
    {
      ...
      difficulty: "intermediate",
      estimatedTime: 8,
      prerequisites: ["cpp-function-reference"],
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Bạn cũng có thể truyền mảng vào hàm: Hàm (myFunction) nhận một mảng làm tham số (int myNumbers[5]) và lặp qua phần tử mảng bằng vòng lặp for. Khi hàm được gọi trong main(), ta truyền mảng myNumbers, và mảng này xuất ra các phần tử. Lưu ý rằng khi gọi hàm, bạn chỉ cần dùng tên mảng khi truyền nó làm đối số myFunction(myNumbers). Tuy nhiên, khai báo đầy đủ của mảng là cần trong tham số hàm (int myNumbers[5]).",
      },
      sections: ["Truyền mảng làm tham số hàm", "Ví dụ"],
      syntax: [
        {
    ...
    },
    {
      ...
      title: "Truyền cấu trúc vào hàm trong C++",
      ...
      difficulty: "intermediate",
      estimatedTime: 11,
      prerequisites: ["cpp-function-array"],
    ...
    },
    {
      ...
      title: "Ví dụ thực tế về hàm trong C++",
      ...
      difficulty: "intermediate",
      estimatedTime: 8,
      prerequisites: ["cpp-function-structures"],
      description:
    ...
    },
    {
      ...
      difficulty: "intermediate",
      estimatedTime: 14,
      prerequisites: ["cpp-function-reallife"],
      description:
      ...
      examples: [
        ...
        },
        {
          ...
          output: "Int: 13\nDouble: 10.56",
          explanation:
            "Ví dụ dưới đây quá tải hàm plusFunc để dùng cho cả int và double:",
        },
        {
          title: "Ví dụ",
          ...
          explanation:
            "Ví dụ này, ta quá tải hàm bằng cách dùng số tham số khác nhau:",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      difficulty: "intermediate",
      estimatedTime: 20,
      prerequisites: ["cpp-function-overloading"],
      description:
      ...
      syntax: [
        {
          code: "int sum(int k) {\n  if (k > 0) {\n    return k + sum(k - 1);\n  } else {\n         return 0;\n  }\n}\n\nint main() {\n  int result = sum(10);\n  cout << result;\n  return 0;\n}",
          explanation:
            "Trong ví dụ sau, đệ quy được dùng để cộng một dải số bằng cách chia nhỏ thành nhiệm vụ cộng hai số đơn giản:",
        },
      ],
      examples: [
        {
    ...
    },
    {
      ...
      difficulty: "intermediate",
      estimatedTime: 20,
      prerequisites: ["cpp-functions-recursion"],
      description:
        "Hàm lambda là một hàm nhỏ, ẩn danh, bạn có thể viết trực tiếp trong code. Hữu ích khi cần một hàm nhanh mà không phải đặt tên hay khai báo riêng.",
      objectives: [
      ...
      examples: [
        ...
        },
        {
          ...
          output: "Hello World!\nHello World!",
          explanation:
            "Trong ví dụ dưới đây, ta gửi một lambda nhỏ vào hàm khác, và hàm đó chạy nó hai lần:",
        },
        {
          ...
          output: "Number: 1\nNumber: 2\nNumber: 3",
          explanation:
            "Bạn có thể định nghĩa và dùng lambda ngay trong vòng lặp, rất hợp với thao tác nhanh:",
        },
        {
          ...
          output: "10",
          explanation:
            "Ví dụ này, lambda capture biến x theo giá trị (một bản sao):",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      slug: "oop",
      title:
        "OOP (lập trình hướng đối tượng) trong C++ (C++ OOP (Object-Oriented Programming))",
      ...
      tables: [
        {
          ...
          header: ["Class", "Đối tượng"],
          rows: [
            ["**TRÁI CÂY**", "Táo, Chuối, Xoài"],
            ["Xe", "Volvo, Audi, Toyota"],
          ],
        },
      ],
      useCases: [
    ...
    },
    {
      id: "cpp-classes",
      slug: "classes",
      title: "Lớp và đối tượng trong C++",
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          output: "Hello World!",
          explanation:
            "Việc này làm bằng cách viết tên lớp, theo sau là toán tử :: rồi tên hàm:",
        },
        {
          title: "Ví dụ",
          ...
          output: "200",
          explanation:
            "Bạn cũng có thể truyền giá trị vào phương thức như hàm thường:",
        },
        {
          title: "Nhiệm vụ thử thách",
          code: '#include <iostream>\n using namespace std;\n\n  class Dog {\n   public:\n     void bark() {\n       cout << "Woof!";\n     }\n };\n\n  int main() {\n   Dog myDog;\n   myDog.bark();\n   return 0;\n }',
          output: "Woof!",
          explanation:
            "Rồi gọi phương thức đó từ main() thông qua một đối tượng.",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      difficulty: "intermediate",
      estimatedTime: 14,
      prerequisites: ["cpp-class-methods"],
      description:
      ...
      examples: [
        ...
        },
        {
          ...
          output: "BMW X5 1999\nFord Mustang 1969",
          explanation:
            "Khi gọi constructor (bằng cách tạo đối tượng của lớp), ta truyền tham số cho constructor, và nó gán giá trị tương ứng cho các thuộc tính:",
        },
        {
          title: "Ví dụ",
          ...
          output: "BMW X5 1999\nFord Mustang 1969",
          explanation:
            "Bạn cũng có thể định nghĩa constructor ngoài lớp dùng toán tử ::.",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      title: "Quá tải constructor trong C++",
      ...
      difficulty: "intermediate",
      estimatedTime: 8,
      prerequisites: ["cpp-constructors"],
      description:
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Trong C++, một lớp có thể có nhiều constructor. Đó gọi là quá tải constructor. Mỗi constructor phải có số lượng hoặc kiểu tham số khác nhau để trình biên dịch biết dùng cái nào khi tạo đối tượng. Lớp này có hai constructor: một không tham số và một có tham số: Quá tải constructor cho phép tạo đối tượng với giá trị tùy chỉnh.",
      },
      sections: ["Nạp chồng khối xây dựng", "Ví dụ với hai constructor"],
      syntax: [
        {
    ...
    },
    {
      ...
      title: "Phạm vi truy cập trong C++",
      ...
      difficulty: "intermediate",
      estimatedTime: 14,
      prerequisites: ["cpp-constructors-overloading"],
      description:
      ...
      examples: [
        ...
        },
        {
          ...
          output: "",
          explanation:
            "Ví dụ sau minh họa khác biệt giữa thành viên public và private:",
          runnable: false,
        },
        {
          title: "Ví dụ",
    ...
    },
    {
      ...
      slug: "encapsulation",
      title: "Đóng gói, Getter và Setter trong C++",
      ...
      difficulty: "intermediate",
      estimatedTime: 8,
      prerequisites: ["cpp-access-specifiers"],
      description:
      ...
      sections: ["sự bao ngoài mặt", "Truy cập thành viên cá nhân", "Ví dụ"],
      syntax: [
        {
    ...
    },
    {
      ...
      title: "Hàm bạn (Friend Functions) trong C++",
      ...
      difficulty: "intermediate",
      estimatedTime: 8,
      prerequisites: ["cpp-encapsulation"],
      description:
        "Thông thường, thành viên private chỉ truy cập được qua phương thức public như getter và setter. Nhưng một số trường hợp, có thể dùng một hàm đặc biệt gọi là friend function để truy cập trực tiếp.",
      objectives: [
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Thông thường, thành viên private chỉ truy cập được qua phương thức public như getter và setter. Nhưng một số trường hợp, có thể dùng một hàm đặc biệt gọi là friend function để truy cập trực tiếp. Hàm friend không phải thành viên của lớp nhưng được phép truy cập dữ liệu private của lớp: Tự trải nghiệm",
      },
      sections: ["Chức năng bạn bè C++", "Ví dụ"],
      syntax: [
        {
    ...
    },
    {
      ...
      difficulty: "intermediate",
      estimatedTime: 8,
      prerequisites: ["cpp-friend-function"],
      description:
        "Kế thừa cho phép một lớp tái sử dụng thuộc tính và phương thức từ lớp khác. Nó giúp viết code gọn và hiệu quả hơn bằng cách tránh trùng lặp.",
      objectives: [
        "Nắm được: Thừa kế C++.",
    ...
    },
    {
      ...
      title: "Kế thừa nhiều cấp trong C++",
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Một lớp cũng có thể kế thừa từ một lớp vốn đã kế thừa từ lớp khác. Ví dụ sau, MyGrandChild kế thừa từ lớp MyChild (mà MyChild lại kế thừa từ MyClass).",
      },
      sections: ["Thừa kế đa cấp"],
      syntax: [
        {
    ...
    },
    {
      ...
      difficulty: "intermediate",
      estimatedTime: 8,
      prerequisites: ["cpp-inheritance-multilevel"],
      description:
    ...
    },
    {
      ...
      title: "Kế thừa và access specifier trong C++",
      ...
      difficulty: "intermediate",
      estimatedTime: 8,
      prerequisites: ["cpp-inheritance-multiple"],
      description:
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Bạn đã học ở chương Access Specifiers rằng C++ có ba specifier. Cho đến nay ta mới chỉ dùng public (thành viên lớp truy cập được từ bên ngoài) và private (chỉ truy cập được bên trong lớp). Specifier thứ ba, protected, giống private nhưng cũng truy cập được trong lớp kế thừa:",
      },
      sections: ["Bộ chỉ định truy cập"],
      syntax: [
        {
    ...
    },
    {
      ...
      difficulty: "intermediate",
      estimatedTime: 11,
      prerequisites: ["cpp-inheritance-access"],
      description:
      ...
      examples: [
        ...
        },
        {
          ...
          explanation:
            "Giờ ta tạo đối tượng Pig và Dog và ghi đè phương thức animalSound():",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      difficulty: "intermediate",
      estimatedTime: 11,
      prerequisites: ["cpp-polymorphism"],
      description:
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Hàm ảo là phương thức của lớp cơ sở, có thể được ghi đè trong lớp dẫn xuất. Hàm ảo là phần cốt lõi của tính đa hình trong C++. Chúng cho phép các đối tượng khác nhau phản hồi khác nhau trước cùng một lời gọi. Không có virtual, C++ quyết định hàm nào được gọi dựa trên kiểu con trỏ, không phải kiểu đối tượng thật. Với virtual, nó kiểm tra đối tượng thật mà con trỏ đang trỏ tới. Hoặc nói đơn giản hơn: Không có virtual thì hàm cơ sở chạy, dù đối tượng thuộc lớp con. Có virtual thì phiên bản của lớp con chạy, đúng như mong đợi. Bây giờ đã chạy đúng! Vì sound() là virtual, lời gọi dùng hàm của đối tượng thật chứ không chỉ theo kiểu con trỏ. Bạn có thể thắc mắc vì sao ta dùng -> trong các ví dụ trên. Toán tử -> dùng để truy cập thành viên (hàm, biến) thông qua con trỏ. Đó là cách viết tắt của (*con_trỏ).thành_viên: Mẹo: nếu dùng con trỏ tới đối tượng, hãy dùng -> để truy cập thành viên.",
      },
      sections: [
        "Chức năng ảo C++",
        "Tại sao dùng hàm ảo?",
      ...
      syntax: [
        {
          ...
          explanation:
            "Hoặc nói đơn giản hơn: Không có virtual thì hàm cơ sở chạy, dù đối tượng thuộc lớp con. Có virtual thì phiên bản của lớp con chạy, đúng như mong đợi.",
        },
      ],
      examples: [
        {
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          output: "Xem vi du trong bai hoc",
          explanation:
            "Bạn cũng có thể dùng template để tạo lớp dùng với mọi kiểu dữ liệu:",
        },
        {
          title: "Ví dụ",
          ...
          output: "Value: 50\nValue: Hello",
          explanation:
            "Ví dụ dưới đây định nghĩa lớp template Box có thể lưu và hiển thị giá trị mọi kiểu dữ liệu, rồi tạo một hộp cho int và một hộp cho string:",
        },
        {
          title: "Ví dụ",
          ...
          explanation:
            "Ví dụ này định nghĩa lớp template Pair lưu hai giá trị khác kiểu và hiển thị chúng, rồi tạo một cặp cho tên và tuổi, một cặp cho ID và điểm:",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          explanation:
            "Lưu ý rằng ta cũng dùng vòng lặp while cùng hàm getline() (thuộc lớp ifstream) để đọc tệp từng dòng và in nội dung tệp:",
        },
      ],
      tables: [
        {
          ...
          rows: [
            ...
            ["ifstream", "Đọc từ các tệp"],
            ["fstream", "Kết hợp ofstream và ifstream: tạo, đọc và ghi tệp"],
          ],
        },
      ],
      useCases: [
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          output: "",
          explanation:
            "Cách thay thế để dùng time() là truyền con trỏ NULL và dùng giá trị trả về.",
        },
        {
          title: "Ví dụ",
      ...
      tables: [
        {
          title: "Ví dụ",
          header: ["Định dạng Bộ chỉ định", "Mô tả", "Ví dụ"],
          rows: [
            ["%a", "Dạng viết tắt của thứ trong tuần", "T6"],
            ["%b", "Dạng viết tắt của tên tháng", "Tháng 12"],
            ["%B", "Tên tháng đầy đủ", "Tháng 12"],
            ["%d", "Ngày trong tháng có số 0 đứng trước", "09"],
            ["%e", "Ngày trong tháng có khoảng trắng đệm", "9"],
            ["%H", "Định dạng 24 giờ của giờ", "14"],
            ["%I", "Định dạng 12 giờ của giờ", "02"],
            ["%M", "Phút trong vòng một giờ", "30"],
            ["%p", "AM or PM", "PM"],
            ["%S", "Giây trong vòng một phút", "01"],
            ["%y", "Biểu diễn năm 2 chữ số", "23"],
            ["%Y", "Biểu diễn năm 4 chữ số", "2023"],
          ],
        },
      ],
      useCases: [
    ...
    },
    {
      ...
      syntax: [
        { code: "cout << myVar;", explanation: "2) Dùng biến chưa khai báo:" },
      ],
      examples: [
        {
    ...
    },
    {
      ...
      syntax: [
        {
          ...
          explanation:
            "Dùng cout in giá trị tại các điểm khác nhau trong mã để xem lỗi ở đâu:",
        },
      ],
      examples: [
        {
      ...
      notes: ['Mẹo: Hãy bắt đầu với "1. Print Debugging".'],
      commonMistakes: [
        {
          wrong: "Bắt exception rồi bỏ qua không xử lý.",
          why: "Lỗi bị nuốt, chương trình tiếp tục ở trạng thái sai.",
    ...
    },
    {
      id: "cpp-exceptions",
      slug: "exceptions",
      title: "Ngoại lệ và xử lý ngoại lệ trong C++",
      ...
      examples: [
        ...
        },
        {
          ...
          explanation:
            "Ta có thể dùng xử lý ngoại lệ để kiểm tra tuổi đủ điều kiện chưa:",
        },
        {
          title: "Ví dụ",
          code: "int main() {\n  int age = 20;\n  return 0;\n}\n",
          output: "",
          explanation:
            "Nếu không có lỗi (ví dụ age là 20 thay vì 15, tức lớn hơn 18), khối catch sẽ được bỏ qua:",
        },
        {
          title: "Ví dụ",
          ...
          output:
            "Access denied - You must be at least 18 years old.\nError number: 505",
          explanation:
            "Bạn cũng có thể dùng từ khóa throw để xuất một số tham chiếu, như một mã lỗi tùy chỉnh để tổ chức (505 trong ví dụ của chúng ta):",
        },
        {
          title: "Ví dụ",
          code: '#include <iostream>\nusing namespace std;\nint main() {\n  try {\n    int age = 15;\n    if (age >= 18) {\n      cout << "Access granted - you are old enough.";\n    } else {\n      throw 505;\n    }\n  }\n  catch (...) {\n    cout << "Access denied - You must be at least 18 years old.\\n";\n  }\n  return 0;\n}\n',
          ...
          explanation:
            'Nếu không biết kiểu throw dùng trong khối try, bạn có thể dùng cú pháp "ba chấm" (...) bên trong khối catch để xử lý mọi loại ngoại lệ:',
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      title: "Kiểm dữ liệu nhập trong C++",
      ...
      difficulty: "intermediate",
      estimatedTime: 14,
      prerequisites: ["cpp-exceptions"],
      description:
        "Khi người dùng nhập dữ liệu, họ có thể gõ những gì không mong đợi. Kiểm dữ liệu nhập bảo đảm dữ liệu đúng trước khi chương trình tiếp tục.",
      objectives: [
    ...
    },
    {
      ...
      title: "Cấu trúc dữ liệu và STL trong C++",
      ...
      syntax: [
        {
          ...
          explanation:
            "Dùng cái nào tùy thuộc nhu cầu cụ thể của bạn. Điểm chung là bạn phải include tệp header tương ứng để dùng chúng:",
        },
      ],
      examples: [
        {
        ...
        },
        {
          ...
          output: "Volvo\nBMW\nFord\nMazda",
          explanation:
            "Ví dụ dùng vector, sau khi đã include thư viện <vector>:",
        },
      ],
      tables: [
        {
          title: "Thư viện Template Chuẩn C++ (C++ STL)",
          header: ["Cấu trúc dữ liệu", "Mô tả"],
          rows: [
            [
              "Véc-tơ",
    ...
    },
    {
      ...
      difficulty: "intermediate",
      estimatedTime: 20,
      prerequisites: ["cpp-data-structures"],
      description:
      ...
      examples: [
        ...
        },
        {
          ...
          output: "",
          explanation:
            "Để tạo vector, dùng từ khóa vector, chỉ định kiểu giá trị trong cặp ngoặc nhọn <> rồi tên vector, như: vector<type> vectorName.",
        },
        {
          title: "Ví dụ",
          code: '#include <iostream>\n#include <string>\n#include <vector>\nusing namespace std;\nint main() {\n  // Create a vector called cars that will store strings\n  vector<string> cars = {"Volvo", "BMW", "Ford", "Mazda"};\n\n  // Print vector elements\n     for (string car : cars) {\n    cout << car << "\\n";\n  }\n  return 0;\n}\n',
          output: "Volvo\nBMW\nFord\nMazda",
          explanation:
            "Nếu muốn thêm phần tử ngay khi khai báo, hãy đặt chúng trong danh sách phân tách dấu phẩy, nằm trong ngoặc nhọn {}, giống như với mảng:",
        },
        {
          title: "Ví dụ",
          ...
          output: "VolvoBMW",
          explanation:
            "Vector cũng như mảng đánh số từ 0: [0] là phần tử đầu, [1] là phần tử thứ hai, v.v.:",
        },
        {
          title: "Ví dụ",
          ...
          output: "VolvoMazda",
          explanation:
            "Một lợi ích của thư viện vector là nhiều hàm hữu ích. Ví dụ, truy cập phần tử đầu hoặc cuối vector bằng .front() và .back():",
        },
        {
          title: "Ví dụ",
          ...
          output: "BMWFord",
          explanation:
            "Để truy cập phần tử tại chỉ mục xác định, dùng hàm .at() và chỉ số mục:",
        },
      ],
      tables: [],
      useCases: [
      ...
      syntax: [
        {
          ...
          explanation:
            "Để dùng list, phải include tệp header <list>: // Include thư viện list #include <list> Tạo một List. Để tạo một list, dùng từ khóa list, và chỉ định kiểu giá trị nó nên lưu trong ngoặc nhọn <> rồi tên của list, như: list<type> listName.",
        },
      ],
      examples: [
        {
        ...
        },
        {
          ...
          output: "VolvoMazda",
          explanation:
            "Tuy nhiên, bạn có thể truy cập phần tử đầu hoặc cuối bằng .front() và .back():",
        },
        {
          title: "Ví dụ",
          ...
          output: "OpelToyota",
          explanation:
            "Bạn cũng có thể đổi giá trị phần tử đầu hoặc cuối bằng .front() và .back()",
        },
        {
          title: "Ví dụ",
          ...
          output: "",
          explanation:
            "Để thêm phần tử vào list, dùng .push_front() để chèn phần tử vào đầu danh sách và .push_back() để thêm phần tử ở cuối:",
        },
        {
          title: "Ví dụ",
          ...
          output: "",
          explanation:
            "Để xóa phần tử khỏi list, dùng .pop_front() để gỡ phần tử ở đầu danh sách và .pop_back() để gỡ phần tử ở cuối:",
        },
      ],
      tables: [],
      useCases: [
      ...
      syntax: [
        {
          ...
          explanation:
            "Để dùng stack, phải include tệp header <stack>: // Include thư viện stack #include <stack> Tạo một Stack. Để tạo một stack, dùng từ khóa stack, và chỉ định kiểu giá trị nó nên lưu trong ngoặc nhọn <> rồi tên của stack, như: stack<type> stackName.",
        },
      ],
      examples: [
        {
        ...
        },
        {
          ...
          output: "",
          explanation:
            "Để thêm phần tử vào stack, dùng .push() sau khi khai báo stack:",
        },
        {
          title: "Ví dụ",
          code: '#include <iostream>\n#include <string>\n#include <stack>\n\nusing namespace std;\n\nint main() {\n  stack<string> cars;\n  cars.push("Volvo");\n  cars.push("BMW");\n  cars.push("Ford");\n  cars.push("Mazda");\n  cout << cars.top();\n  return 0;\n}\n',
          output: "Mazda",
          explanation:
            "Trong stack, bạn chỉ truy cập được phần tử trên cùng, bằng hàm .top():",
          input: "",
        },
        {
          title: "Ví dụ",
          ...
          output: "Tesla",
          explanation:
            "Bạn cũng có thể dùng .top để đổi giá trị phần tử trên cùng:",
          input: "",
        },
        {
          title: "Ví dụ",
      ...
      syntax: [
        {
          ...
          explanation:
            "Để dùng queue, phải include tệp header <queue>: // Include thư viện queue #include <queue> Tạo một Queue. Để tạo một queue, dùng từ khóa queue, và chỉ định kiểu giá trị nó nên lưu trong ngoặc nhọn <> rồi tên của queue, như: queue<type> queueName.",
        },
      ],
      examples: [
        {
        ...
        },
        {
          ...
          output: "Volvo Mazda",
          explanation:
            "Trong queue, bạn chỉ truy cập được phần tử đầu hoặc cuối bằng .front() và .back():",
          input: "",
        },
        {
          title: "Ví dụ",
          ...
          output: "Tesla VW",
          explanation:
            "Bạn cũng có thể dùng .front và .back để đổi giá trị phần tử đầu và cuối:",
          input: "",
        },
        {
          title: "Ví dụ",
          ...
          output: "BMW",
          explanation:
            "Thao tác này gỡ phần tử đầu (phần tử cũ nhất được thêm vào queue):",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      description:
        "Ở trang trước, bạn đã học rằng phần tử trong queue được thêm ở cuối và xóa ở đầu. Tuy nhiên, deque (hàng đợi hai đầu) linh hoạt hơn, vì phần tử có thể được thêm và xóa từ cả hai đầu (đầu và cuối).",
      objectives: [
      ...
      syntax: [
        {
          ...
          explanation:
            "Để dùng deque, phải include tệp header <deque>: // Include thư viện deque #include <deque> Tạo một Deque. Để tạo một deque, dùng từ khóa deque, và chỉ định kiểu giá trị nó nên lưu trong ngoặc nhọn <> rồi tên của deque, như: deque<type> dequeName.",
        },
      ],
      examples: [
        {
        ...
        },
        {
          ...
          output: "VolvoBMW",
          explanation:
            "Deque đánh số từ 0: [0] là phần tử đầu, [1] là phần tử thứ hai, v.v.:",
        },
        {
          title: "Ví dụ",
          code: '#include <iostream>\n#include <string>\n#include <deque>\nusing namespace std;\nint main() {\n  // Create a deque called cars that will store strings\n     deque<string> cars = {"Volvo", "BMW", "Ford", "Mazda"};\n\n  // Get the first element\n     cout << cars.front();\n\n  // Get the last element\n     cout << cars.back();\n  return 0;\n}\n',
          output: "VolvoMazda",
          explanation:
            "Bạn cũng có thể truy cập phần tử đầu hoặc cuối của deque bằng .front() và .back():",
        },
        {
          title: "Ví dụ",
          code: '#include <iostream>\n#include <string>\n#include <deque>\nusing namespace std;\nint main() {\n  // Create a deque called cars that will store strings\n  deque<string> cars = {"Volvo", "BMW", "Ford", "Mazda"};\n\n  // Get the second element\n     cout << cars.at(1);\n\n  // Get the third element\n     cout << cars.at(2);\n  return 0;\n}\n',
      ...
      syntax: [
        {
          ...
          explanation:
            "Để dùng set, phải include tệp header <set>: // Include thư viện set #include <set> Tạo một Set. Để tạo một set, dùng từ khóa set, và chỉ định kiểu giá trị nó nên lưu trong ngoặc nhọn <> rồi tên của set, như: set<type> setName.",
        },
      ],
      examples: [
        {
        ...
        },
        {
          ...
          output: "1\n2\n3\n5\n7\n9",
          explanation:
            "Nếu lưu số nguyên vào set, giá trị trả về được sắp theo số:",
        },
        {
          title: "Ví dụ",
          ...
          output: "9\n7\n5\n3\n2\n1",
          explanation:
            "Mặc định, phần tử trong set được sắp tăng dần. Muốn đảo thứ tự, dùng functor greater<type> trong cặp ngoặc nhọn, như sau:",
        },
        {
          title: "Ví dụ",
          ...
          output: "BMW\nFord\nMazda\nVolvo",
          explanation:
            'Ví dụ, nếu thêm "BMW" hai lần vào set, phần tử trùng sẽ bị bỏ qua:',
        },
        {
          title: "Ví dụ",
          code: '#include <string>\n#include <set>\nusing namespace std;\nint main() {\n  set<string> cars = {"Volvo", "BMW", "Ford", "Mazda"};\n\n  // Add new elements\n  cars.insert("Tesla");\n  cars.insert("VW");\n  cars.insert("Toyota");\n  cars.insert("Audi");\n  return 0;\n}\n',
          output: "",
          explanation:
            "Để thêm phần tử vào set, bạn có thể dùng hàm .insert():",
        },
      ],
      tables: [],
      useCases: [
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          output: "John is: 32\nAdele is: 45",
          explanation:
            "Thay vào đó, bạn truy cập phần tử map bằng khóa trong ngoặc vuông []:",
        },
        {
          title: "Ví dụ",
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          output: "",
          explanation:
            "Để hiểu chúng hoạt động, ta tiếp tục dùng vector làm ví dụ:",
        },
        {
          title: "Ví dụ",
          code: '#include <iostream>\n#include <string>\n#include <vector>\n\nusing namespace std;\n\nint main() {\n  vector<string> cars = {"Volvo", "BMW", "Ford", "Mazda"};\n  vector<string>::iterator it;\n  it = cars.begin();\n  cout << *it;\n  return 0;\n}\n',
          output: "Volvo",
          explanation:
            'begin() trỏ đến phần tử đầu của vector (chỉ mục 0, là "Volvo"):',
          input: "",
        },
        {
          title: "Ví dụ",
          ...
          output: "BMW",
          explanation:
            "Để trỏ tới phần tử thứ hai (BMW), viết cars.begin() + 1:",
          input: "",
        },
        {
          title: "Ví dụ",
          ...
          output: "Ford",
          explanation:
            "Và tất nhiên, điều đó cũng có nghĩa là bạn có thể trỏ tới phần tử thứ ba bằng cars.begin() + 2:",
          input: "",
        },
        {
          title: "Ví dụ",
          ...
          output: "Mazda",
          explanation:
            "Vậy để dùng end() trỏ tới phần tử cuối của vector cars (Mazda), dùng cars.end() - 1:",
          input: "",
        },
      ],
      tables: [],
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          output: "",
          explanation:
            "Hàm sort() nhận các iterator (thường là iterator đầu từ begin() trả về và iterator cuối từ end() trả về) làm tham số:",
        },
        {
          title: "Ví dụ",
          ...
          output: "",
          explanation:
            "Nếu là vector số nguyên, chúng sẽ được sắp theo giá trị số:",
        },
        {
          title: "Ví dụ",
          ...
          output: "",
          explanation:
            "Để đảo thứ tự, dùng rbegin() và rend() thay cho begin() và end():",
        },
        {
          title: "Ví dụ",
    ...
    },
    {
      ...
      difficulty: "intermediate",
      estimatedTime: 17,
      prerequisites: ["cpp-algorithms"],
      description:
        "Namespace là cách gom các đoạn mã liên quan dưới một tên. Nó giúp tránh xung đột tên khi code lớn dần hoặc khi dùng mã từ nhiều nguồn.",
      objectives: [
      ...
      examples: [
        ...
        },
        {
          ...
          output: "42",
          explanation:
            "Nếu không muốn viết tên namespace mỗi lần truy cập biến, hãy dùng từ khóa using:",
        },
        {
          ...
          output: "Hello World!",
          explanation:
            "Để code ngắn hơn, thêm: using namespace std; Cách này cho phép dùng cout, cin và endl mà không cần viết std:: mỗi lần.",
        },
        {
          title: "Không gian tên std",
          code: '#include <iostream>\n using namespace std;\n\n int main() {\n   cout << "Hello World!\\n";\n   return 0;\n }',
    ...
    },
    {
      id: "cpp-projects",
      slug: "projects",
      title: "Dự án và ứng dụng thực hành trong C++",
      ...
      syntax: [
        {
          ...
          explanation:
            "Chương trình yêu cầu người dùng nhập từ 1 đến 5 điểm và tính điểm trung bình. Sau đó hiển thị giá trị trung bình và xếp hạng chữ cái tương ứng (A đến F):",
        },
      ],
      examples: [
        {
          ...
          code: '#include <iostream>\n#include <string>\n\nusing namespace std;\n\nchar gradeFunction(double avg) {\n  if (avg >= 90) return \'A\';\n  else if (avg >= 80) return \'B\';\n  else if (avg >= 70) return \'C\';\n  else if (avg >= 60) return \'D\';\n  else return \'F\';\n}\n\nint main() {\n  int count;\n  double sum = 0, grade;\n\n  cout << "How many grades (1 to 5)? ";\n  cin >> count;\n\n  if (count < 1 || count > 5) {\n    cout << "Invalid number. You must enter between 1 and 5 grades.\\n";\n    return 1;\n  }\n\n  for (int i = 1; i <= count; i++) {\n    cout << "Enter grade " << i << ": ";\n    cin >> grade;\n    sum += grade;\n  }\n\n  double avg = sum / count;\n  cout << "Average: " << avg << "\\n";\n  cout << "Letter grade: " << gradeFunction(avg) << "\\n";\n  return 0;\n}\n',
          output:
            "How many grades (1 to 5)? Enter grade 1: Enter grade 2: Enter grade 3: Average: 80\nLetter grade: B",
          explanation:
            "Chương trình yêu cầu người dùng nhập từ 1 đến 5 điểm và tính điểm trung bình. Sau đó hiển thị giá trị trung bình và xếp hạng chữ cái tương ứng (A đến F):",
          input: "3 90 80 70",
        },
      ...
      tables: [],
      useCases: ["Viết code hiện đại an toàn hơn.", "Dự án C++ thực tế."],
      notes: [
    ...
    },
    {
      ...
      title: "Cách cộng hai số trong C++",
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Học cách cộng hai số trong C++: Ví dụ này, người dùng phải nhập hai số. Sau đó ta in tổng bằng cách cộng hai số:",
      },
      sections: ["Thêm hai số", "Cộng hai số với dữ liệu nhập"],
      syntax: [
        {
          code: "int x = 5;\nint y = 6;\nint sum = x + y;\ncout << sum;",
    ...
    },
    {
      ...
      title: "Cách tạo số ngẫu nhiên trong C++",
      ...
      difficulty: "beginner",
      estimatedTime: 14,
      prerequisites: ["cpp-howto-add-two-numbers"],
      description:
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Bạn có thể dùng rand() (trong thư viện <cstdlib>) để sinh số ngẫu nhiên: Để kiểm soát tốt hơn số ngẫu nhiên, ví dụ nếu chỉ muốn một số ngẫu nhiên trong khoảng 0 đến 100, bạn có thể dùng công thức sau: Lưu ý: các ví dụ trên chỉ xuất một số ngẫu nhiên. Chúng không ra số khác nhau mỗi lần chạy. Sẽ sinh số ngẫu nhiên từ 0 đến 10 mỗi lần chạy chương trình:",
      },
      sections: ["Số ngẫu nhiên", "Ví dụ"],
      syntax: [
        {
          code: "cout << rand();",
          explanation:
      ...
      examples: [
        ...
        },
        {
          ...
          output: "",
          explanation:
            "Để kiểm soát tốt hơn số ngẫu nhiên, ví dụ nếu chỉ muốn một số ngẫu nhiên trong khoảng 0 đến 100, bạn có thể dùng công thức sau:",
        },
        {
          title: "Ví dụ",
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 8,
      prerequisites: ["cpp-howto-random-number"],
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Phần này chứa tài liệu tham chiếu C++. Danh sách từ khóa C++ và thư viện phổ biến ở đây:",
      },
      sections: ["Tham chiếu C++"],
      syntax: [
        {
          code: "#include <iostream>\n#include <cstdlib>\n#include <ctime>\nusing namespace std;\n\nint main() {\n  srand(time(0));\n  cout << rand() % 100;\n  return 0;\n}",
          explanation:
    ...
    },
    {
      ...
      difficulty: "beginner",
      estimatedTime: 8,
      prerequisites: ["cpp-ref-reference"],
      ...
      tables: [
        {
          title: "Từ khóa C++",
          header: ["Từ khóa", "Mô tả"],
          rows: [
            ["và", "Cách viết thay thế cho toán tử logic &&"],
            ["and_eq", "Cách viết thay thế cho toán tử gán &="],
            [
              "tự động",
              "Tự động nhận diện kiểu của biến dựa trên giá trị bạn gán cho nó",
            ],
            ["bitand", "Cách viết thay thế cho toán tử bit &"],
            ["bitor", "Một cách viết thay thế cho", "toán tử bitwise"],
            ["bool", "Kiểu dữ liệu chỉ lưu giá trị true hoặc false"],
            ["phá vỡ", "Thoát khỏi vòng lặp hoặc khối switch"],
            ["...", "Đánh dấu một khối mã trong câu lệnh switch"],
            [
              "bắt lấy, nắm lấy, tóm lấy, chộp lấy",
              "Bắt ngoại lệ sinh ra từ khối try",
            ],
            ["char", "Kiểu dữ liệu lưu được một ký tự duy nhất"],
            ["hạng", "Định nghĩa một lớp"],
            ["Khiếu nại.", "Cách viết thay thế cho toán tử bit ~"],
            [
              "(thuộc) dây chằng",
              "Định nghĩa biến hoặc tham số là hằng số (không đổi) hoặc chỉ định phương thức lớp khô",
            ],
            ["tiếp tục, làm tiếp", "Chuyển sang vòng lặp tiếp theo"],
            ["default", "Chỉ định khối mã mặc định trong câu lệnh switch"],
            ["xóa", "Giải phóng bộ nhớ động"],
            ["do", "Dùng cùng while để tạo vòng lặp do/while"],
            ["double", "Kiểu dữ liệu thường 64 bit, lưu được số thập phân"],
            ["khác, nữa; nếu không", "Được dùng trong câu lệnh điều kiện"],
            ["ENUM", "Khai báo kiểu liệt kê"],
            ["sai, nhầm, giả dối", "Giá trị boolean tương đương 0"],
            ["float", "Kiểu dữ liệu thường 32 bit, lưu được số thập phân"],
            ["cho", "Tạo một vòng lặp for"],
            [
              "người bạn",
              "Chỉ định lớp và hàm được truy cập thành viên private và protected",
            ],
            ["ĐI ĐẾN", "Nhảy đến dòng mã được chỉ định bởi nhãn"],
            ["if", "Tạo một câu lệnh điều kiện"],
            ["int", "Kiểu dữ liệu thường 32 bit, lưu được số nguyên"],
            [
              "dài, xa; lâu",
              "Đảm bảo số nguyên dài ít nhất 32 bit (dùng long long để đủ 64 bit)",
            ],
            ["Không gian tên", "Khai báo không gian tên"],
            ["Cấp mới", "Dự trữ bộ nhớ động"],
            ["không", "Cách viết thay thế cho toán tử logic !"],
            ["not_eq", "Cách viết thay thế cho toán tử so sánh !="],
            ["or", "Một cách viết thay thế cho phép logic", "TRÁI"],
            ["or_eq", "Một cách viết thay thế cho", "= toán tử gán"],
            [
              "riêng tư",
            ...
            ["Trở lại", "Dùng để trả về giá trị từ hàm"],
            ["ngắn, cụt", "Giảm kích thước số nguyên xuống 16 bit"],
            [
              "đã ký",
            ...
            ["mẫu", "Khai báo lớp template hoặc hàm template"],
            [
              "việc này",
              "Biến khả dụng bên trong phương thức và constructor của lớp, chứa con trỏ tới chí",
            ],
            ["vứt đi", "Tạo lỗi tùy chỉnh có thể được bắt bởi try...catch"],
            ["đúng, thật", "Giá trị boolean tương đương 1"],
            ["thử", "Tạo câu lệnh try...catch"],
            ["typedef", "Định nghĩa một kiểu dữ liệu tùy chỉnh"],
            [
              "không được ký tên",
            ...
            ["virtual", "Chỉ định phương thức lớp là virtual (ảo)"],
            [
              "vô giá trị",
              "Chỉ định hàm không trả về giá trị, hoặc con trỏ tới dữ liệu chưa xác định kiể",
            ],
            ["trong khi", "Tạo một vòng lặp while"],
            ["XOR", "Cách viết thay thế cho toán tử bit ^"],
            ["xor_eq", "Cách viết thay thế cho toán tử gán ^="],
          ],
        },
      ],
      useCases: [
      ...
      keyTakeaways: ["Danh sách từ khóa hữu ích trong C++ ở bảng dưới đây."],
      exerciseIds: [],
      quiz: [],
    ...
    },
    {
      id: "cpp-ref-iostream",
      slug: "ref-iostream",
      title: "Tham chiếu thư viện iostream C++",
      titleEn:
        "C++ iostream Library (Standard Input / Output Streams) Reference",
      num: 135,
      chapter: "15 · How-To & Tra cứu thư viện",
      topic: "Basics",
      difficulty: "beginner",
      estimatedTime: 8,
      prerequisites: ["cpp-ref-keywords"],
      description:
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Thư viện <iostream> cung cấp đối tượng đọc dữ liệu nhập và xuất dữ liệu ra bảng điều khiển hoặc tệp. Danh sách toàn bộ đối tượng iostream ở bảng dưới đây.",
      },
      sections: ["Đối tượng iostream C++"],
      syntax: [
        {
          code: "#include <iostream>\n#include <cstdlib>\n#include <ctime>\nusing namespace std;\n\nint main() {\n  srand(time(0));\n  cout << rand() % 100;\n  return 0;\n}",
          explanation:
      ...
      tables: [
        {
          ...
          header: ["Đối tượng", "Mô tả"],
          rows: [
            ["cerr", "Luồng xuất cho thông báo lỗi"],
            ["tắc nghẽn", "Luồng xuất để ghi log thông tin chương trình"],
            ["CIN", "Luồng nhập mặc định đọc bàn phím từ bảng điều khiển"],
            ["cout", "Luồng xuất mặc định ghi ra bảng điều khiển"],
            [
              "wcerr",
    ...
    },
    {
      id: "cpp-ref-fstream",
      slug: "ref-fstream",
      title: "Tham chiếu thư viện fstream C++",
      ...
      difficulty: "beginner",
      estimatedTime: 8,
      prerequisites: ["cpp-ref-iostream"],
      description:
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Thư viện <fstream> cung cấp các lớp đọc/ghi tệp hoặc luồng dữ liệu. Danh sách các lớp fstream hữu ích ở bảng dưới đây. Tìm hiểu thêm về tệp trong Hướng dẫn C++ Files của chúng tôi.",
      },
      sections: ["Các lớp dòng C++"],
      syntax: [
        {
          code: "#include <iostream>\n#include <cstdlib>\n#include <ctime>\nusing namespace std;\n\nint main() {\n  srand(time(0));\n  cout << rand() % 100;\n  return 0;\n}",
          explanation:
      ...
      tables: [
        {
          ...
          rows: [
            ...
            ["fstream", "Một lớp có thể đọc và ghi tệp"],
            ["ifstream", "Một lớp có thể đọc từ tệp"],
            ["ofstream", "Một lớp có thể ghi vào tệp"],
          ],
        },
      ],
      useCases: [
    ...
    },
    {
      id: "cpp-ref-math",
      slug: "ref-math",
      title: "Tham chiếu thư viện cmath của C++",
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Thư viện <cmath> có nhiều hàm thực hiện phép toán trên số. Danh sách toàn bộ hàm toán học ở bảng dưới đây: Tìm hiểu thêm về toán học trong Hướng dẫn C++ Math của chúng tôi.",
      },
      sections: ["Hàm toán học C++"],
      syntax: [
        {
          code: "#include <iostream>\n#include <cstdlib>\n#include <ctime>\nusing namespace std;\n\nint main() {\n  srand(time(0));\n  cout << rand() % 100;\n  return 0;\n}",
          explanation:
      ...
      tables: [
        {
          ...
          header: ["Chức năng", "Mô tả"],
          rows: [
            ["abs(x)", "Trả về giá trị tuyệt đối của x"],
            ["acos(x)", "Trả về acos của x, tính bằng radian"],
            ["acosh(x)", "Trả về acos hyperbolic của x"],
            ["asin(x)", "Trả về asin của x, tính bằng radian"],
            ["asinh(x)", "Trả về asin hyperbolic của x"],
            [
              "atan(x)",
            ...
            ["atanh(x)", "Trả về atan hyperbolic của x"],
            ["cbrt(x)", "Trả về căn bậc ba của x"],
            ["trần(x)", "Trả về x được làm tròn lên số nguyên gần nhất"],
            [
              "copysign(x, y)",
              "Trả về số thực x đầu tiên mang dấu của số thực y thứ hai",
            ],
            ["cos(x)", "Trả về cos của x (x tính bằng radian)"],
            ["cosh(x)", "Trả về cos hyperbolic của x"],
            ["điểm kinh nghiệm(x)", "Trả về giá trị của E mũ x"],
            ["exp2(x)", "Trả về giá trị của 2 mũ x"],
            ["expm1(x)", "Trả về e x -1"],
            ["erf(x)", "Trả về giá trị hàm sai số (error function) tại x"],
            ["erfc(x)", "Trả về giá trị hàm sai số bù tại x"],
            ["fab(x)", "Trả về giá trị tuyệt đối của số thực x"],
            ["fdim(x, y)", "Trả về hiệu dương giữa x và y"],
            ["tầng(x)", "Trả về x được làm tròn xuống số nguyên gần nhất"],
            ["fma(x, y, z)", "Trả về x*y+z mà không mất độ chính xác"],
            ["fmax(x, y)", "Trả về giá trị lớn hơn trong hai số thực x và y"],
            ["fmin(x, y)", "Trả về giá trị nhỏ hơn trong hai số thực x và y"],
            ["fmod(x, y)", "Trả về phần dư số thực của phép x/y"],
            [
              "frexp(x, y)",
            ...
            ["ilogb(x)", "Trả về phần nguyên của logarit cơ số số thực của x"],
            ["ldexp(x, y)", "Trả về x*2 y"],
            [
              "lgamma(x)",
            ...
            ["log(x)", "Trả về logarit tự nhiên của x"],
            ["log10(x)", "Trả về logarit cơ số 10 của x"],
            ["log1p(x)", "Trả về logarit tự nhiên của x+1"],
            ["log2(x)", "Trả về logarit cơ số 2 của giá trị tuyệt đối của x"],
            [
              "logb(x)",
            ...
            ["nan", "Trả về giá trị NaN (Not a Number)"],
            ["nearbyint(x)", "Trả về x được làm tròn đến số nguyên gần nhất"],
            ["tiếp theo (x, y)", "Trả về số thực gần x nhất theo hướng của y"],
            ["bên cạnh (x, y)", "Trả về số thực gần x nhất theo hướng của y"],
            ...
            ["rint(x)", "Trả về x được làm tròn đến số nguyên gần nhất"],
            ["Bo Tròn Góc X:", "Trả về x được làm tròn đến số nguyên gần nhất"],
            ["scalbln(x, y)", "Trả về x mũ y (y thường là 2)"],
            ["tỷ lệ (x, y)", "Trả về x mũ y (y thường là 2)"],
            ["tội lỗi(x)", "Trả về sin của x (x tính bằng radian)"],
            ["sinh(x)", "Trả về sin hyperbolic của x"],
            ["sqrt(x)", "Trả về căn bậc hai của x"],
            ["tan(x)", "Trả về tan của x (x tính bằng radian)"],
            ["tanh(x)", "Trả về tan hyperbolic của x"],
            ["tgamma(x)", "Trả về giá trị hàm gamma tại x"],
    ...
    },
    {
      id: "cpp-ref-string",
      slug: "ref-string",
      title: "Tham chiếu thư viện string của C++",
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Thư viện <string> có nhiều hàm thao tác trên chuỗi. Danh sách toàn bộ hàm string ở bảng dưới đây. Tìm hiểu thêm về chuỗi trong Hướng dẫn C++ Strings của chúng tôi.",
      },
      sections: ["Hàm chuỗi C++"],
      syntax: [
        {
          code: "#include <iostream>\n#include <cstdlib>\n#include <ctime>\nusing namespace std;\n\nint main() {\n  srand(time(0));\n  cout << rand() % 100;\n  return 0;\n}",
          explanation:
      ...
      tables: [
        {
          ...
          header: ["Chức năng", "Mô tả"],
          rows: [
            ["nối thêm", "Thêm ký tự hoặc chuỗi khác vào cuối chuỗi hiện tại"],
            ["at()", "Trả về ký tự tại chỉ mục xác định, có kiểm tra biên"],
            ["quay lại", "Truy cập ký tự cuối cùng của chuỗi"],
            ["bắt đầu", "Trả về iterator trỏ đến ký tự đầu của chuỗi"],
            ["c_str()", "Trả về chuỗi kiểu C kết thúc bằng null"],
            ["thông thoáng", "Xóa mọi ký tự, làm chuỗi trở nên rỗng"],
            [
              "so sánh, đối chiếu",
              "So sánh chuỗi với chuỗi khác và trả về kết quả",
            ],
            ["sao chép", "Sao chép ký tự của chuỗi vào mảng ký tự"],
            ["dữ liệu", "Trả về con trỏ tới mảng ký tự nội bộ của chuỗi"],
            ["trống, rỗng; uống, làm cạn", "Kiểm tra xem chuỗi có rỗng không"],
            ["kết thúc", "Trả về iterator trỏ ngay sau ký tự cuối cùng"],
            ["xóa", "Xóa một phần chuỗi theo vị trí và độ dài"],
            ["Tìm", "Tìm lần xuất hiện đầu của ký tự hoặc chuỗi con"],
            ["phía trước", "Truy cập ký tự đầu tiên của chuỗi"],
            [
              "chèn vào, lồng vào",
              "Chèn ký tự hoặc chuỗi con vào vị trí xác định",
            ],
            ["chiều dài", "Trả về số ký tự của chuỗi"],
            ["Diện tích tối đa", "Trả về số ký tự tối đa của chuỗi"],
            ["nhà điều hành", "Trả về ký tự tại vị trí đã cho"],
            ["pop_back()", "Xóa ký tự cuối khỏi chuỗi"],
            ["push_back()", "Thêm một ký tự vào cuối chuỗi"],
            ["thay thế", "Thay thế một phần chuỗi bằng nội dung mới"],
            ["rfind()", "Tìm lần xuất hiện cuối của ký tự hoặc chuỗi con"],
            ["Đổi Kích Thước", "Thay đổi độ dài chuỗi, cắt ngắn hoặc đệm thêm"],
            ["kích thước", "Bí danh của length(); trả về độ dài chuỗi"],
            [
              "substr()",
              "Trả về một phần chuỗi, bắt đầu tại chỉ mục và độ dài đã cho",
            ],
            ["hoán đổi", "Trao đổi nội dung của hai chuỗi"],
          ],
        },
      ],
      useCases: [
    ...
    },
    {
      id: "cpp-ref-cstring",
      slug: "ref-cstring",
      title: "Tham chiếu thư viện cstring của C++",
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Thư viện <cstring> có nhiều hàm thao tác trên mảng và chuỗi kiểu C. Lưu ý rằng chuỗi kiểu C khác chuỗi thường. Chuỗi kiểu C là mảng ký tự, tạo bằng kiểu char. Danh sách toàn bộ hàm cstring ở bảng dưới đây. Tìm hiểu thêm về chuỗi kiểu C trong Hướng dẫn C-Style Strings.",
      },
      sections: ["Hàm C++ cstring"],
      syntax: [
        {
          code: "#include <iostream>\n#include <cstdlib>\n#include <ctime>\nusing namespace std;\n\nint main() {\n  srand(time(0));\n  cout << rand() % 100;\n  return 0;\n}",
          explanation:
      ...
      tables: [
        {
          ...
          rows: [
            ...
            ["memcpy()", "Sao chép dữ liệu từ khối nhớ này sang khối nhớ khác"],
            [
              "memmove()",
              "Sao chép dữ liệu giữa hai khối nhớ, tính đến khả năng hai khối nhớ chồng lên nh",
            ],
            ["memset()", "Đặt mọi byte của khối nhớ cùng một giá trị"],
            ["strcat()", "Nối một chuỗi kiểu C vào cuối chuỗi khác"],
            [
              "strchr()",
            ...
            ["strerror()", "Trả về chuỗi kiểu C mô tả ý nghĩa mã lỗi"],
            ["strlen()", "Trả về độ dài chuỗi kiểu C"],
            [
              "strncat()",
            ...
            ["strtok()", "Tách chuỗi thành các phần theo ký tự phân cách"],
            [
              "strxfrm()",
    ...
    },
    {
      id: "cpp-ref-ctime",
      slug: "ref-ctime",
      title: "Tham chiếu thư viện <ctime> của C++",
      ...
      tables: [
        {
          ...
          rows: [
            ...
            ["difftime()", "Trả về khoảng thời gian giữa hai timestamp"],
            [
              "gmtime()",
            ...
            ["mktime()", "Chuyển cấu trúc tm thành timestamp"],
            [
              "strftime()",
              "Ghi chuỗi kiểu C biểu diễn ngày giờ của cấu trúc tm với nhiều định dạng xử lý",
            ],
            ["Thời gian", "Trả về timestamp biểu thị thời điểm hiện tại"],
          ],
        },
      ],
      useCases: [
      ...
      keyTakeaways: ["Thư viện <ctime> có nhiều hàm cho phép đo ngày và giờ."],
      exerciseIds: [],
      quiz: [],
    ...
    },
    {
      id: "cpp-ref-vector",
      slug: "ref-vector",
      title: "Tham chiếu thư viện vector của C++",
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Thư viện <vector> có nhiều hàm thao tác trên vector. Danh sách hàm vector phổ biến ở bảng dưới đây. Tìm hiểu thêm về vector trong Hướng dẫn C++ Vector của chúng tôi.",
      },
      sections: ["Thư viện vectơ C++"],
      syntax: [
        {
          code: "#include <iostream>\n#include <cstdlib>\n#include <ctime>\nusing namespace std;\n\nint main() {\n  srand(time(0));\n  cout << rand() % 100;\n  return 0;\n}",
          explanation:
      ...
      tables: [
        {
          ...
          header: ["Chức năng", "Mô tả"],
          rows: [
            ["Gán", "Lấp đầy vector bằng nhiều giá trị"],
            ["at()", "Trả về phần tử theo chỉ mục của vector"],
            ["quay lại", "Trả về phần tử cuối của vector"],
            ["bắt đầu", "Trả về iterator trỏ đến đầu vector"],
            [
              "năng lực, khả năng tiếp thu, năng suất",
              "Trả về số phần tử mà vùng nhớ đã dành của vector chứa được",
            ],
            ["thông thoáng", "Xóa toàn bộ nội dung của vector"],
            [
              "dữ liệu",
              "Trả về con trỏ tới khối nhớ chứa các phần tử của vector",
            ],
            ["trống, rỗng; uống, làm cạn", "Kiểm tra vector có rỗng hay không"],
            ["kết thúc", "Trả về iterator trỏ đến cuối vector"],
            ["xóa", "Xóa một số phần tử khỏi vector"],
            ["phía trước", "Trả về phần tử đầu của vector"],
            ["chèn vào, lồng vào", "Chèn một số phần tử vào vector"],
            ["Diện tích tối đa", "Trả về số phần tử tối đa vector có thể có"],
            ["pop_back()", "Xóa phần tử cuối của vector"],
            ...
            ["Đặt trước", "Dành bộ nhớ cho vector"],
            [
              "Đổi Kích Thước",
            ...
            ["kích thước", "Trả về số lượng phần tử của vector"],
            ["hoán đổi", "Hoán đổi nội dung của hai vector"],
          ],
        },
      ],
      useCases: [
    ...
    },
    {
      ...
      slug: "ref-algorithm",
      title: "Tham chiếu thư viện algorithm của C++",
      ...
      concept: {
        title: "Khái niệm",
        content:
          "Thư viện <algorithm> có nhiều hàm cho phép biến đổi dải dữ liệu trong cấu trúc dữ liệu. Danh sách hàm hữu ích của thư viện algorithm ở dưới đây. Tìm hiểu thêm về thuật toán trong Hướng dẫn C++ Algorithm.",
      },
      sections: ["Thư viện thuật toán C++"],
      syntax: [
        {
          code: "#include <iostream>\n#include <cstdlib>\n#include <ctime>\nusing namespace std;\n\nint main() {\n  srand(time(0));\n  cout << rand() % 100;\n  return 0;\n}",
          explanation:
      ...
      tables: [
        {
          ...
          rows: [
            ...
            ["sao chép", "Sao chép giá trị của dải dữ liệu sang dải khác"],
            ["đếm", "Đếm số lần một giá trị xuất hiện trong dải dữ liệu"],
            ["count_if()", "Đếm số phần tử của dải dữ liệu thỏa điều kiện"],
            ["tô phủ kín", "Ghi một giá trị vào mọi phần tử của dải dữ liệu"],
            [
              "Tìm",
            ...
            ["Mỗi bức.", "Chạy một hàm trên mọi phần tử của dải dữ liệu"],
            [
              "bao gồm",
            ...
            ["is_sorted()", "Kiểm tra một dải dữ liệu đã được sắp xếp chưa"],
            [
              "is_sorted_until()",
            ...
            ["max_element()", "Tìm phần tử lớn nhất trong dải dữ liệu"],
            ["Trộn", "Trộn giá trị của hai dải dữ liệu thành dải mới"],
            ["min_element()", "Tìm phần tử nhỏ nhất trong dải dữ liệu"],
            [
              "none_of()",
            ...
            ["tìm kiếm", "Tìm một dãy giá trị cho trước trong dải dữ liệu"],
            [
              "thứ, hạng loại; phân loại",
              "Sắp xếp dải dữ liệu theo thứ tự tăng dần",
            ],
            ["hoán đổi", "Hoán đổi giá trị của hai biến"],
            [
              "swap_ranges()",
    ...
    },
    {
      id: "cpp-compiler",
      slug: "compiler",
      title: "Trình biên dịch C++ trực tuyến",
      ...
      difficulty: "beginner",
      estimatedTime: 8,
      prerequisites: ["cpp-real-life-examples"],
      description:
      ...
      concept: {
        title: "Khái niệm",
        content:
          'Với trình biên dịch C++ trực tuyến, bạn sửa mã và xem kết quả ngay trên trình duyệt. Nhấn nút "Try it Yourself" để xem nó hoạt động. Nếu chưa biết C++, hãy đọc Hướng dẫn C++ của chúng tôi từ đầu.',
      },
      sections: ["Trình biên dịch C++ (Trình soạn thảo)"],
      syntax: [
        {
          code: '#include <iostream>\nusing namespace std;\n\nint main() {\n  cout << "Hello World!";\n  return 0;\n}',
          explanation:
